    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          ...
          <el-form-item label="结果key:">
            <el-input v-model="searchForm.resultKey" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="值key:">
            <el-input v-model="searchForm.valueKey" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="jobKey" label="统计" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="resultKey" label="结果key" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="value1" label="VAL" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="value2" label="VAL" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="value3" label="VAL" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="value4" label="VAL" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="value5" label="VAL" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="value6" label="VAL" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="value7" label="VAL" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="value8" label="VAL" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="value9" label="VAL" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="value10" label="VAL" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="valueKey" label="值key" sortable="custom" width="200"></el-table-column>
            <el-table-column label="操作" width="450" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary" icon="el-icon-more"
                           @click="toDetail(scope.row.jobKey,scope.row.resultKey)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.jobKey,scope.row.resultKey)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
  ...
  export default {
    data() {
      return {
        ...
        statisticsResultsStatusCodeOptions: [{"label": "全部", "name": ""}],
        statisticsResultsStatusCodeValue: null,
        form: {
    ...
    created() {
      let jobKey = this.$route.query.jobKey;
      this.params.jobKey = jobKey;
    },
    activated() {
      //只刷新数据，不改变整体的缓存
      // console.log('重新活跃路由');
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/admin/detailStatisticsResults/add/' + 0;
        this.$router.push({path: opath})
      },
      toDetail(jobKey,resultKey) {
        let opath = '/admin/detailStatisticsResults/detail/' + jobKey;
        this.$router.push({path: opath})
      },
    }
  }
