        ...
        <el-form :label-position="'right'" class="schoolForm-rao"
          ...
          <el-col :span="12">
            <el-form-item label="搜索关键字 *  :" prop="keyword">
              <el-input v-model="formData.keyword" maxlength="32"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="推荐 :" prop="isRecommended">
              <el-select v-model="formData.isRecommended" placeholder="请您选择">
                <el-option v-for="isRecommendedItem in ynOptions" :key="isRecommendedItem.name"
          ...
          <el-col :span="12">
            <el-form-item label="信息类型 :" prop="entityType">
              <el-select v-model="formData.entityType" placeholder="请您选择">
                <el-option v-for="item in entityType" :key="item.entityTypeId"
                           :label="item.entityCnName" :value="item.entityEnName">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          ...
          <!--<el-col :span="12">-->
            <!--<el-form-item label="信息类型 :" prop="entityName">-->
              <!--<el-input v-model="formData.entityName" maxlength="64"></el-input>-->
            <!--</el-form-item>-->
          <!--</el-col>-->
          ...
          <el-col :span="12">
            <el-form-item label="热门推荐 :" prop="isHot">
              <el-select v-model="formData.isHot" placeholder="请您选择">
                <el-option v-for="isHotItem in ynOptions" :key="isHotItem.name"
        ...
        <el-form :label-position="'right'" class="schoolForm-rao"
          ...
          <el-col :span="12">
            <el-form-item label="使用人次 :" prop="usedTimes">
              <el-input v-model="formData.usedTimes" maxlength="11"></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
            ...
            <el-form :label-position="'right'" class="schoolForm-rao schoolForm-detail-rao" label-width="165px"
              ...
              <el-col :span="12" v-if="formData.isRecommended">
                <el-form-item label="推荐 :" prop="isRecommended">
                  <el-switch v-model="formData.isRecommended == 'Y'" disabled></el-switch>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12" v-if="formData.isHot">
                <el-form-item label="热门推荐 :" prop="isHot">
                  <el-switch v-model="formData.isHot == 'Y'" disabled></el-switch>
                </el-form-item>
              </el-col>
...
<script>
  ...
  import api2 from "@/views/safety/entity/entitytype/entitytypeUrl";
  ...
  export default {
    data() {
      return {
        ...
        ynOptions: [{"label": "全部", "name": ""}], isRecommended: null,
        entityType:[],
        isHot: null,
        formData: {
          keywordId: '',
        ...
        rules: {
          keyword: [
            {required: true, message: "请您输入搜索关键字", trigger: "blur"},
    ...
    methods: {
      ...
      getEntityType() {
          ...
          api2.fetchList(params).then(res => {
            if (res.data.resultCode === "000000") {
              this.entityType = res.data.data.records
            }
            this.isLoaded = false;
          }, res => {
            this.$message.error(res.message);
