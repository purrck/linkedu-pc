          ...
          <el-row>
            <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
              ...
              <el-form :label-position="'right'" label-width="200px" ref="formData" :inline="false"
                ...
                <!--<el-select v-model="formData.segmentId" class="select-v2-rao block" popper-class="select-popper-v2-rao" @change="xueduanChange" placeholder="请您选择">-->
                <!--<el-option v-for="schoolRunTypeCodeItem in basicSegmentAdOptions" :key="schoolRunTypeCodeItem.name"-->
                <!--:label="schoolRunTypeCodeItem.label" :value="schoolRunTypeCodeItem.name"></el-option>-->
                <!--</el-select>-->
                <!--</el-form-item>-->
                <!--</el-col>-->
                ...
                <el-col :span="24">
                  <el-form-item label="学校介绍 :" prop="orgIntroduction">
                    <!--<UEditor :config="config" :defaultMsg="defaultMsg" ref="ue" style="line-height: 1;"></UEditor>-->
            ...
            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
              <div class="menu-quickly">
                <ul>
                  ...
                  <li>
                    <router-link :to="`/basedata/listOrgschoolcalendar/?schoolOrgId=${formData.schoolOrgId}`"><img
                      src="~@/assets/img/menu_quickly/icon_clendar.png"/>校历
                    </router-link>
                  </li>
                  <li>
                    <router-link :to="`/basedata/listOrgschooltimeline/?schoolOrgId=${formData.schoolOrgId}`"><img
        ...
        set[formName].validate((valid) => {
          ...
          if (valid) {
            ...
            if (this.pageState === "edit") {
              ...
              api.basicSchoolOrgAdAdd(this.formData).then((res) => {
                if (res.data.resultCode == "000000") {
                  this.formLoading = false;
