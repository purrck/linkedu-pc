    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          <el-form-item label="模板部门:">
            <el-input v-model="searchForm.tempDepartId" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="部门名称:">
            <el-input v-model="searchForm.tempDepartName" maxlength="30"></el-input>
          </el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="tempDepartName" label="部门名称" sortable="custom"></el-table-column>
...
<!--                           @click.stop="toEdit(scope.row.tempDepartId)">-->
<!--                  编辑-->
<!--                </el-button>-->
<!--                <el-button size="small" type="primary"-->
<!--                           @click="toDetail(scope.row.tempDepartId)">-->
<!--                  详情-->
<!--                </el-button>-->
<!--                <el-button size="small" type="danger"-->
<!--                           @click="rowDel(scope.row.tempDepartId)">删除-->
<!--                </el-button>-->
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                  <span slot="reference"
                        @click.stop="toEdit(scope.row.tempDepartId)"><i
                ...
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.tempDepartId)"><i
                ...
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="删除" trigger="hover">
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.tempDepartId)"><i
                    class="iconfont icon-icon_shanchu_caozuo ml5 f20 c999999"></i></span>
                </el-popover>
                <!--<el-button size="small" type="primary"  @click="toDetail(scope.row.tempDepartId)">-->
                <!--部门职位-->
                <!--</el-button>-->
              </template>
            </el-table-column>
...
<script>
  ...
  export default {
    ...
    created() {
      // let orgDepartTempId = this.$route.query.orgDepartTempId
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/basedata/detailTempDepart/add/' + 0;
        this.$router.push({
          path: opath,
          query: {
            orgDepartTempId: this.$route.query.orgDepartTempId,
            orgDepartTempName: this.$route.query.orgDepartTempName,
          }})
      },
      toEdit(id) {
        let opath = '/basedata/detailTempDepart/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailTempDepart/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
