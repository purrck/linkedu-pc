      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="schoolTerm" label="学期" align="center" sortable="custom">
              <template slot-scope="scope">
                <span v-if="scope.row.schoolTerm">{{scope.row.schoolTerm}}</span>
                <span v-else>无</span>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    toAdd () {
      ...
      let opath = '/basedata/detailOrgSchoolCalendar/add/' + 0
    ...
    toEdit (id) {
      let opath = '/basedata/detailOrgSchoolCalendar/edit/' + id
      this.$router.push({path: opath})
    },
    toDetail (id) {
      let opath = '/basedata/detailOrgSchoolCalendar/detail/' + id
      this.$router.push({path: opath})
    },
    toAnother (id, path) {
