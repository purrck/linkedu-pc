    ...
    <div class="edit-box">
      <div v-if="pageState == 'add'">
        ...
        <el-form :label-position="'right'" class="schoolForm-rao"
          ...
          <el-col :span="12">
            <el-form-item label="部门 *  :" prop="tempDepartName">
              <el-input v-model="formData.tempDepartName" maxlength="32" disabled></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="对应群组 :" prop="groupId">
          ...
          <el-col :span="12">
            <el-form-item label="对应群组 :" prop="groupName">
              <el-input v-model="formData.groupName" maxlength="32"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="上级职位 :" prop="parentName">
        ...
        <el-row>
          <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
            ...
            <el-form :label-position="'right'" class="edit-form" label-width="165px"
              ...
              <el-col :span="12" v-if="formData.tempPositionId">
                <el-form-item label="部门职位 :" prop="tempPositionId">
                  {{formData.tempPositionId}}
                </el-form-item>
              </el-col>


              <el-col :span="12" v-if="formData.tempDepartId">
                <el-form-item label="部门 :" prop="tempDepartId">
    ...
    data() {
      return {
        ...
        rules: {
          ...
          description: [
            {required: true, message: "请您输入职位描述", trigger: "blur"},
        ...
        if (this.pageState !== 'add') {
          api.getObj(paramsId).then(res => {
            if (res.data.resultCode == "000000") {
              ...
              this.formData.tempPositionId = this.data.tempPositionId;


              this.formData.tempDepartId = this.data.tempDepartId;


              this.formData.positionName = this.data.positionName;
          ...
          this.formData.tempDepartName = this.$route.query.tempDepartName
          this.formData.tempDepartId = this.$route.query.tempDepartId
        }
      }
    }
  }
