            ...
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                <div class="flex  row">
                  ...
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.classTeacherId)"><i
...
export default {
  data () {
    return {
      ...
      teacherStatusCodeOptions: [{'label': '全部', 'name': ''}],
  ...
  methods: {
    ...
    //删除
    toTotal () {
      let opath = '/safety/CourseClassTeacherTotal'
