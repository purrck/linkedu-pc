    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          ...
          <el-form-item label="课时类型"  prop="securityEducationTypeCode">
...
export default {
  ...
  mounted () {
    ...
    commonApi.getCourseType('courseType4AQ').then(res=>{
  ...
  methods: {
    ...
    dialogDeleteComfireHandler () {
      this.isDel = true
      api.batchDelObjNew(this.multipleSelection).then(res => {
        this.isDel = false
    ...
    toAdd () {
      ...
      let opath = '/safetyEdu/detailCourseChapter?type=add&resourceType=courseType4AQ'
    ...
    toEdit (id) {
      let opath = `/safetyEdu/detailCourseChapter?type=edit&resourceId=${id}&resourceType=courseType4AQ`
      this.$router.push({path: opath})
    },
    toDetail (id) {
