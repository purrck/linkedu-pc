            ...
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                <div class="flex  row">
                  ...
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.courseClassId)"><i
...
<script>
import api from './courseclassUrl'
...
export default {
  data () {
    return {
      ...
      courseClassStatusCodeOptions: [{'label': '全部', 'name': ''}],
      courseClassStatusCodeValue: null,
      form: {},
      searchForm: {},
      data: '',
      multipleSelection: [],
  ...
  mounted () {
    ...
    commonApi.getCodeIntType('courseClassStatus').then(res => {
      let viewList = res.data.data || []
      for (let courseClassStatusItem of viewList) {
        this.courseClassStatusCodeOptions.push({
          'label': courseClassStatusItem.codeDesc,
          'name': courseClassStatusItem.codeId
        })
      }
    }, res => {
  ...
  methods: {
    ...
    //删除
    toTotal () {
      let opath = '/safety/CourseClassTotal'
