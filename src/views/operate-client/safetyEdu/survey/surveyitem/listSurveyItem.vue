      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="promptTextId" align="center" label="提示文字" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.promptTextId" class="one-line">{{scope.row.promptTextId}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="mandatoryInd" align="center" label="必答" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.mandatoryInd" class="one-line">{{scope.row.mandatoryInd}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    toAdd () {
      ...
      let opath = '/safetyEdu/detailSurveyItem/add/' + 0
      this.$router.push({path: opath})
    },
    toTotal () {
      let opath = '/safetyEdu/SurveyItemTotal'
      this.$router.push({path: opath})
    },
    toEdit (id) {
      let opath = '/safetyEdu/detailSurveyItem/edit/' + id
      this.$router.push({path: opath})
    },
    toDetail (id) {
      let opath = '/safetyEdu/detailSurveyItem/detail/' + id
      this.$router.push({path: opath})
    },
  }
}
