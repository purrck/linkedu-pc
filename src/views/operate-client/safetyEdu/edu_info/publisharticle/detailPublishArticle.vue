        ...
        <div class="main--form">
          <el-form ref="form" :model="formData" label-width="80px">
            ...
            <el-form-item label="标题">
              <el-input size="small" v-model="formData.title" placeholder="请输入标题"></el-input>
            </el-form-item>
            ...
            <el-form-item label="作者">
              <el-input size="small" v-model="formData.author" placeholder="请输入作者"></el-input>
            </el-form-item>

            <el-form-item label="来源">
              <el-input size="small" v-model="formData.origin" placeholder="请输入来源"></el-input>
            </el-form-item>
