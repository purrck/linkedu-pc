      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="columnName" label="栏目" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="tempName" label="模板名称" sortable="custom"></el-table-column>
            <!--<el-table-column label="预览图片" width="200">-->
            <!--<template slot-scope="scope">-->
            <!--<div v-if="scope.row.imagePathList">-->
            <!--<img :src="scope.row.imagePathList[0]" alt="" width="100px" class="scope-img">-->
            <!--</div>-->
            <!--<div v-else>暂无数据</div>-->
            <!--</template>-->
            <!--</el-table-column>-->
            <el-table-column prop="isCurrent" label="当前应用" width="150px" sortable="custom">
              <template slot-scope="scope">
            ...
            <el-table-column label="操作" width="300" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           ...
                           @click.stop="toEdit(scope.row.tempId)">
                  编辑
                </el-button>
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.tempId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.tempId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/safetyEdu/detailPublishTemplate/add/' + 0
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/safetyEdu/detailPublishTemplate/edit/' + id
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safetyEdu/detailPublishTemplate/detail/' + id
        this.$router.push({path: opath})
      },
    }
  }
