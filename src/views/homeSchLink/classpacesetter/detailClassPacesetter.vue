        ...
        <el-form :label-position="'right'" class="edit-form"
          ...
          <el-col :span="24">
            <el-form-item label="类型 :" prop="pacesetterTypeCode">
              <el-select class="select-v2-rao" v-model="formData.pacesetterTypeCode" placeholder="请您选择">
            ...
            <el-form :label-position="'right'" label-width="120px"
              ...
              <div class="p100">
                ...
                <div class="detail-item-v2">
                  ...
                  <div class="p50">
                    <el-form-item label="类型 :" prop="pacesetterTypeCode">
                            <span v-if="formData.pacesetterTypeCodeStr"
                                  :style="{'color':formData.pacesetterTypeCodeStr.split(';')[1]}">{{formData.pacesetterTypeCodeStr.split(';')[0]}}</span>
                    </el-form-item>
                  </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        imagePathFileList: [],
        imagePathFileType: '',
        pacesetterTypeCodeOptions: [{"label": "全部", "name": ""}], pacesetterTypeCode: null,
        formData: {
          classPacesetterId: '',
          imagePath: "",
          pacesetterTypeCode: "",
