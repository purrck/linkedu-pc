      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          <el-form-item label="适合年级:" prop="gradeNames">
            <el-input class="input-v2-rao" v-model="searchForm.gradeNames" maxlength="30"></el-input>
          </el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="gradeNames" align="center" label="适合年级" sortable="custom">
              <template slot-scope="scope">
            ...
            <el-table-column label="操作" fixed="right" width="150">
              <template slot-scope="scope">
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                    <span slot="reference"
                          @click.stop="toEdit(scope.row.classCommitteeId)"><i
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.classCommitteeId)"><i
                  ...
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.classCommitteeId)"><i
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/homeSchLink/detailClassCommitteeDuty/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/homeSchLink/ClassCommitteeDutyTotal';
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/homeSchLink/detailClassCommitteeDuty/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/homeSchLink/detailClassCommitteeDuty/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
