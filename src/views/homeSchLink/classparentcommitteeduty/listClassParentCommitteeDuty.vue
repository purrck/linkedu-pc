<template>
  <div class="ClassParentCommitteeDuty">
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          ...
          <el-form-item label="适合年级:" prop="gradeNames" class="w140">
            <el-input class="input-v2-rao" v-model="searchForm.gradeNames" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="家委类型:" prop="parentClassCommitteeCode" class="w140">
            <el-select class="select-v2-rao" v-model="searchForm.parentClassCommitteeCode" placeholder="请您选择">
            ...
            <el-table-column label="操作" fixed="right" width="150">
              <template slot-scope="scope">
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                    <span slot="reference"
                          @click.stop="toEdit(scope.row.parentClassCommitteeId)"><i
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.parentClassCommitteeId)"><i
                  ...
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.parentClassCommitteeId)"><i
  ...
  export default {
    data() {
      return {
        ...
        parentClassCommitteeCodeOptions: [{"label": "全部", "name": ""}],
    ...
    methods: {
      ...
      handleSelectionChange(val) {
        this.multipleSelection = val.map(item => {
          return item.parentClassCommitteeId
        });
      },
      ...
      toAdd() {
        ...
        let opath = '/homeSchLink/detailClassParentCommitteeDuty/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/homeSchLink/ClassParentCommitteeDutyTotal';
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/homeSchLink/detailClassParentCommitteeDuty/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/homeSchLink/detailClassParentCommitteeDuty/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
