    ...
    <div class="edit-box">
      <div v-if="pageState === 'add'">
        ...
        <el-form :label-position="'right'" class="edit-form"
          ...
          <el-col :span="24">
            <el-form-item label="家长用户id :" prop="userId">
              <el-input class="input-v2-rao" v-model="formData.userId"
                        maxlength="32"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="家长 :" prop="userName">
              <el-input class="input-v2-rao" v-model="formData.userName"
                        maxlength="32"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="签到时间 :" prop="checkedDt">
            ...
            <el-form :label-position="'right'" label-width="120px"
              ...
              <div class="p100">
                ...
                <div class="detail-item-v2">
                  <div class="p50" v-if="formData.userId">
                    <el-form-item label="家长用户id :" prop="userId">
                      <span v-if="formData.userId">{{formData.userId}}</span>
                    </el-form-item>
                  </div>
