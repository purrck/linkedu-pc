    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          ...
          <el-form-item label="家长:" prop="userName" class="w140">
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="userName" align="center" label="家长" sortable="custom">
              <template slot-scope="scope">
            ...
            <el-table-column prop="checkedDt" label="签到时间" align="center" sortable="custom"></el-table-column>
              ...
              <template slot-scope="scope">
                <div class="flex  row space-between" style="padding: 0 20px">
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                    <span slot="reference"
                          @click.stop="toEdit(scope.row.checklistId)"><i
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.checklistId)"><i
                  ...
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.checklistId)"><i
...
<script>
  import api from "./classmeetingchecklistUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/homeSchLink/detailMeetingChecklist2/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/homeSchLink/MeetingChecklistTotal';
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/homeSchLink/detailMeetingChecklist2/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/homeSchLink/detailMeetingChecklist2/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
