    ...
    <div class="edit-box">
      <div v-if="pageState === 'add'">
        ...
        <el-form :label-position="'right'" class="edit-form"
          ...
          <el-col :span="24">
            <el-form-item label="会议主题 :" prop="meetingTopic">
              <el-input class="input-v2-rao" v-model="formData.meetingTopic"
                        maxlength="255"  placeholder="请输入会议主题"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="24">
            <el-form-item label="受邀人 :" prop="studentUserIds" class="orgIntroduction">
              <send-object :header="header" @finish="finish"></send-object>
            </el-form-item>
          </el-col>

          <el-col :span="24">
            <el-form-item label="受邀学生 :" prop="studentNames">
              <span v-for="it in formData.studentNames">{{`${it}, `}}</span>
            </el-form-item>
          </el-col>

          <el-col :span="24">
            <el-form-item label="会议地址 :" prop="localGps" class="orgIntroduction">
              <el-input class="input-v2-rao" v-model="formData.localGps"
          ...
          <!--</el-col>-->
          <el-col :span="24">
            <el-form-item label="会议im群 :" prop="meetingImNum">
              <el-input class="input-v2-rao" v-model="formData.meetingImNum"
                        maxlength="32"></el-input>
            </el-form-item>
          </el-col>
        </el-form>
      ...
      <div v-if="pageState === 'edit'">
        <el-form :label-position="'right'" class="edit-form"
          ...
          <!--<el-col :span="24">-->
            <!--<el-form-item label="会议地址 :" prop="localGps" class="w280">-->
              <!--<el-input v-model="localGpsModel">-->
                <!--<el-button slot="append" icon="el-icon-search"-->
                           <!--@click="localGpsSearch"></el-button>-->
              <!--</el-input>-->
            ...
            <el-form :label-position="'right'" label-width="120px"
              ...
              <div class="p100">
                ...
                <div class="detail-item-v2">
                  ...
                  <div class="p50" v-if="formData.meetingImNum">
                    <el-form-item label="会议im群 :" prop="meetingImNum">
                      <span v-if="formData.meetingImNum">{{formData.meetingImNum}}</span>
                    </el-form-item>
                  </div>
                </div>
              </div>
              ...
              <ul>
                <li>
                  <router-link :to="`/basedata/listMeetingChecklist?meetingId=`+
                                  formData.meetingId">
                    <i class="iconfont icon-icon_liebiao"></i>家长会家长签到
                  </router-link>
                </li>
              </ul>
            </div>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          studentUserIds:
            [
              {required: true, message: "请您选择受邀学生", trigger: "blur"},
            ],
          meetingBeginDt:
            [
          ...
          meetingEndDt:
            [
              {required: true, message: "请您输入结会时间", trigger: "blur"},
            ],
          participantsNum:
            [
    ...
    methods: {
      ...
      localGpsPoint(type) {
        ...
        this.localGpsMarkerPoint = {
          lat:localGpsCurrPoint.lat,
          lng:localGpsCurrPoint.lng
         }
