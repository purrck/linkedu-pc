    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          ...
          <el-form-item label="开会中:" prop="isOpening" class="w140">
          ...
          <el-form-item label="联系邮件:" prop="contactEmail" class="w140">
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="meetingImNum" align="center" label="会议im群" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.meetingImNum" class="one-line">{{scope.row.meetingImNum}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
            <el-table-column label="操作" fixed="right" width="180">
              <template slot-scope="scope">
                <div class="flex  row">
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="家长会家长签到" trigger="hover">
                      <span slot="reference" @click.stop="toAnother(scope.row.meetingId ,`listMeetingChecklist2`)"><i
...
<script>
  import api from "./classmeetinginfoUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/homeSchLink/detailClassMeetingInfo/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/homeSchLink/MeetingInfoTotal';
        // this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/homeSchLink/detailClassMeetingInfo/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/homeSchLink/detailClassMeetingInfo/detail/' + id;
        this.$router.push({path: opath})
      },
      toAnother(id, path) {
        let opath = '/homeSchLink/' + path+ '?meetingId=' + id;
        this.$router.push({path: opath})
      },
    }
  }
