...
<!-- 重大疫情 colName:title sqlType:VARCHAR notnull:false -->
                  <el-col :span="24">
                    <el-form-item label="处理 :" prop="esProcessTitle">
                      <el-input class="input-v2-rao" v-model="formData.esProcessTitle"
                                maxlength="128"></el-input>
                    </el-form-item>
                  </el-col>
...
<!-- 处理内容 colName:content sqlType:VARCHAR notnull:false -->
                  <el-col :span="24">
                    <el-form-item label="处理时间 :" prop="processedDt">
                      <el-date-picker class="date-v2-rao" v-model="formData.processedDt" type="datetime"
                                      placeholder="选择日期"
            ...
            <el-form :label-position="'right'" label-width="120px"
              ...
              <div class="p100">
                <div class="detail-title-v2 ">
                      {{formData.esProcessTitle}}
                </div>
                <div class="detail-item-v2">
                        <div class="p50" v-if="formData.esProcessTitle">
                          <el-form-item label="处理 :" prop="esProcessTitle">
                            <span v-if="formData.esProcessTitle">{{formData.esProcessTitle}}</span>
                          </el-form-item>
                        </div>
                        ...
                        <div class="p50">
                          <el-form-item label="处理时间 :" prop="processedDt">
                            <span v-if="formData.processedDt"> {{formData.processedDt}}</span>
                          </el-form-item>
                        </div>
