          ...
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                ...
                <el-popover
                  v-if="scope.row.schoolMessageStatusCode == 'editing' || scope.row.schoolMessageStatusCode == 'reject'"
                  placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                    <span slot="reference"
                ...
                <el-popover
                  v-if="scope.row.schoolMessageStatusCode == 'editing' || scope.row.schoolMessageStatusCode == 'reject'"
                  placement="top-start" popper-class="popover-v2-rao" title="删除" trigger="hover">
                  <span slot="reference"
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/newApplications/detailSchoolMessage/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/newApplications/SchoolMessageTotal';
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/newApplications/detailSchoolMessage/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/newApplications/detailSchoolMessage/detail/' + id;
        this.$router.push({path: opath})
      },
      toAnother(id, path) {
