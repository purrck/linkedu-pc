...
export default {
  ...
  methods: {
    ...
    toAdd() {
      ...
      let opath = "/newApplications/detailStudentGroupUser/add/" + 0;
      this.$router.push({ path: opath });
    },
    toTotal() {
      let opath = "/newApplications/StudentGroupUserTotal";
      this.$router.push({ path: opath });
    },
    toEdit(id) {
      let opath = "/newApplications/detailStudentGroupUser/edit/" + id;
      this.$router.push({ path: opath });
    },
    toDetail(id) {
      let opath = "/newApplications/detailStudentGroupUser/detail/" + id;
      this.$router.push({ path: opath });
    }
  }
};
