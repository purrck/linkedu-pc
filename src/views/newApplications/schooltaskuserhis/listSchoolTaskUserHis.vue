...
export default {
  ...
  methods: {
    ...
    toAdd() {
      ...
      let opath = "/newApplications/detailSchoolTaskUserHis/add/" + 0;
      this.$router.push({ path: opath });
    },
    toTotal() {
      let opath = "/newApplications/SchoolTaskUserHisTotal";
      this.$router.push({ path: opath });
    },
    toEdit(id) {
      let opath = "/newApplications/detailSchoolTaskUserHis/edit/" + id;
      this.$router.push({ path: opath });
    },
    toDetail(id) {
      let opath = "/newApplications/detailSchoolTaskUserHis/detail/" + id;
      this.$router.push({ path: opath });
    }
  }
};
