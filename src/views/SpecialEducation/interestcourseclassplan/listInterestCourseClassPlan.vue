<template>
  <div class="InterestCourseClassPlan">
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          ...
          <el-form-item label="日期:" prop="planedDt" class="w140">
            <el-date-picker class="date-v2-rao" v-model="searchForm.planedDt" type="date"
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="weekNum" align="center" label="兴趣班" sortable="custom">
            ...
            <el-table-column prop="weekNum" align="center" label="周几" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.weekNum==1" class="one-line">周一</div>
                <div v-else-if="scope.row.weekNum==2" if="scope.row.weekNum" class="one-line">周二</div>
                <div v-else-if="scope.row.weekNum==3" if="scope.row.weekNum" class="one-line">周三</div>
                <div v-else-if="scope.row.weekNum==4" if="scope.row.weekNum" class="one-line">周四</div>
                <div v-else-if="scope.row.weekNum==5" if="scope.row.weekNum" class="one-line">周五</div>
                <div v-else-if="scope.row.weekNum==6" if="scope.row.weekNum" class="one-line">周六</div>
                <div v-else-if="scope.row.weekNum==7" if="scope.row.weekNum" class="one-line">周日</div>
                <div v-else>无</div>
              </template>
            </el-table-column>


            <!--<el-table-column prop="planedDt" label="日期" align="center" sortable="custom"></el-table-column>-->
            <el-table-column prop="beginTime" align="center" label="开始时间" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.beginTime" class="one-line">{{scope.row.beginTime}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
            <el-table-column prop="endTime" align="center" label="截止时间" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.endTime" class="one-line">{{scope.row.endTime}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
            <el-table-column prop="classHour" align="center" label="学时数" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.classHour" class="one-line">{{scope.row.classHour}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
            ...
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                ...
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                    <span slot="reference"
                          @click.stop="toEdit(scope.row.planId)"><i
                ...
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.planId)"><i
                ...
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="删除" trigger="hover">
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.planId)"><i
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/SpecialEducation/detailInterestCourseClassPlan/add/0?interestCourseClassId=' + this.$route.query.interestCourseClassId + '&interestCourseClassName=' + this.$route.query.interestCourseClassName + '&segmentId=' + this.$route.query.segmentId + '&gradeId=' + this.$route.query.gradeId + '&schoolYear=' + this.$route.query.schoolYear + '&schoolTerm=' + this.$route.query.schoolTerm;
        ;
      ...
      toTotal() {
        let opath = '/SpecialEducation/InterestCourseClassPlanTotal';
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/SpecialEducation/detailInterestCourseClassPlan/edit/' + id + '?interestCourseClassId=' + this.$route.query.interestCourseClassId + '&interestCourseClassName=' + this.$route.query.interestCourseClassName + '&segmentId=' + this.$route.query.segmentId + '&gradeId=' + this.$route.query.gradeId + '&schoolYear=' + this.$route.query.schoolYear + '&schoolTerm=' + this.$route.query.schoolTerm;
        ;

        // let opath = '/SpecialEducation/detailInterestCourseClassPlan/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/SpecialEducation/detailInterestCourseClassPlan/detail/' + id + '?interestCourseClassId=' + this.$route.query.interestCourseClassId + '&interestCourseClassName=' + this.$route.query.interestCourseClassName;
        this.$router.push({path: opath})
      },
    }
  }
