<template>
  <div class="HabitAssignmentRecord">
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          ...
          <el-form-item label="获取的红花数:" prop="flowerValue" class="w140">
            <el-input class="input-v2-rao" v-model="searchForm.flowerValue" maxlength="30"></el-input>
          </el-form-item>
          ...
          <el-form-item label="家长姓名:" prop="parentName" class="w140">
            <el-input class="input-v2-rao" v-model="searchForm.parentName" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="完成时间:" prop="completedDt" class="w140">
            <el-date-picker class="date-v2-rao" v-model="searchForm.completedDt" type="date"
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="flowerValue" align="center" label="获取的红花数" sortable="custom">
              <template slot-scope="scope">
            ...
            <el-table-column prop="completedDt" label="完成时间" align="center" sortable="custom"></el-table-column>
...
<script>
  import api from "./habitassignmentrecordUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toTotal() {
        let opath = '/specialEdu/HabitAssignmentRecordTotal';
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/specialEdu/detailHabitAssignmentRecord/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
