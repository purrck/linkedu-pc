    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          <el-form-item label="任务类型id:" prop="assignmentTypeId" class="w140">
            <el-input class="input-v2-rao" v-model="searchForm.assignmentTypeId" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="任务类型:" prop="assignmentTypeTitle" class="w140">
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="assignmentTypeTitle" align="center" label="任务类型" sortable="custom">
            ...
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                ...
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                    <span slot="reference"
                          @click.stop="toEdit(scope.row.assignmentTypeId)"><i
                ...
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.assignmentTypeId)"><i
                ...
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="删除" trigger="hover">
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.assignmentTypeId)"><i
                    class="iconfont icon-icon_shanchu_caozuo ml5 f20 c999999"></i></span>
                </el-popover>

                <el-popover placement="top-start" popper-class="popover-v2-rao" title="任务" trigger="hover">
                      <span slot="reference" @click.stop="toAnother(scope.row.assignmentTypeId ,`listHabitAssignment`)"><i
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/specialEdu/detailHabitAssignmentType/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/specialEdu/HabitAssignmentTypeTotal';
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/specialEdu/detailHabitAssignmentType/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/specialEdu/detailHabitAssignmentType/detail/' + id;
        this.$router.push({path: opath})
      },
      toAnother(id, path) {
        let opath = '/specialEdu/' + path + '?assignmentTypeId=' + id;
        this.$router.push({path: opath})
      },
    }
  }
