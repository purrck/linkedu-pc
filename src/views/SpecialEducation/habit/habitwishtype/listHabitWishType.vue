    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          <el-form-item label="心愿类型id:" prop="wishTypeId" class="w140">
            <el-input class="input-v2-rao" v-model="searchForm.wishTypeId" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="心愿类型名:" prop="wishTypeName" class="w140">
            <el-input class="input-v2-rao" v-model="searchForm.wishTypeName" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="被选次数:" prop="selectedNum" class="w140">
            <el-input class="input-v2-rao" v-model="searchForm.selectedNum" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="wishTypeName" align="center" label="心愿类型名" sortable="custom">
            ...
            <el-table-column prop="description" align="center" label="说明" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.description" class="one-line" v-html="scope.row.description" ></div>
                <div v-else>无</div>
              </template>
            </el-table-column>
            ...
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                ...
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                    <span slot="reference"
                          @click.stop="toEdit(scope.row.wishTypeId)"><i
                ...
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.wishTypeId)"><i
                ...
                <el-popover placement="top-start" popper-class="popover-v2-rao" title="删除" trigger="hover">
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.wishTypeId)"><i
                    class="iconfont icon-icon_shanchu_caozuo ml5 f20 c999999"></i></span>
                </el-popover>

                <el-popover placement="top-start" popper-class="popover-v2-rao" title="心愿" trigger="hover">
                      <span slot="reference" @click.stop="toAnother(scope.row.wishTypeId ,`listHabitWish`)"><i
...
<script>
  import api from "./habitwishtypeUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/specialEdu/detailHabitWishType/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/specialEdu/HabitWishTypeTotal';
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/specialEdu/detailHabitWishType/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/specialEdu/detailHabitWishType/detail/' + id;
        this.$router.push({path: opath})
      },
      toAnother(id, path) {
        let opath = '/specialEdu/' + path + '?wishTypeId=' + id;
        this.$router.push({path: opath})
      },
    }
  }
