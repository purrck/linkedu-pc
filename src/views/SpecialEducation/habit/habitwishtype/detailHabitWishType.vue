    ...
    <div class="edit-box">
        <div v-if="pageState === 'add'">
          ...
          <el-form :label-position="'right'" class="edit-form"
                  ...
                  <el-col :span="24">
                    <el-form-item label="心愿类型名 *  :" prop="wishTypeName">
                      <el-input class="input-v2-rao" v-model="formData.wishTypeName"
          ...
          <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
            ...
            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
              <div class="menu-quickly">
                <ul>
                  <li>
                    <router-link :to="`/specialEdu/listHabitWish?wishTypeId=`+
                                  formData.wishTypeId">
                      <i class="iconfont icon-icon_liebiao"></i>心愿
                    </router-link>
                  </li>
                </ul>
              </div>
    ...
    data() {
      return {
        ...
        rules : {
              wishTypeName :
              [
                  {required: true, message: "请您输入心愿类型名", trigger: "blur"},
              ...
              description :
              [
                  {required: true, message: "请您输入说明", trigger: "blur"},
