      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          ...
          <el-form-item label="类别状态" prop="parentId">
            <el-select clearable v-model="searchForm.publicClassCode" placeholder="类别状态">
              <el-option
...
export default {
  ...
  methods: {
    ...
    toAdd () {
      ...
      let opath = '/safetyEdu/detailPublishColumn/add/' + 0
    ...
    toEdit (id) {
      let opath = '/safetyEdu/detailPublishColumn/edit/' + id
      this.$router.push({path: opath})
    },
    toDetail (id) {
      let opath = '/safetyEdu/detailPublishColumn/detail/' + id
      this.$router.push({path: opath})
    },
    toChild (id) {
      this.$router.push({path: '/safetyEdu/listPublishColumnChild', query: {columnId: id}})
    }
  }
}
</script>
