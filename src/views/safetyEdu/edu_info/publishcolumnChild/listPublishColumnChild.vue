...
export default {
  ...
  methods: {
    ...
    toAdd () {
      ...
      let opath = `/safetyEdu/detailPublishColumnChild?type=add&columnId=${this.columnId}`
    ...
    toEdit (id) {
      ...
      let opath = `/safetyEdu/detailPublishColumnChild?type=edit&columnId=${this.columnId}&childColumnId=${id}`
      this.$router.push({path: opath})
    },
    toDetail (id) {
      let opath = `/safetyEdu/detailPublishColumnChild?type=detail&columnId=${this.columnId}&childColumnId=${id}`
      this.$router.push({path: opath})
    },
  }
}
