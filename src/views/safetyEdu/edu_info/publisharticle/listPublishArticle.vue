          ...
          <el-col :span="24" class="text-left mb-10 flex row btns x-center">
            ...
            <div style="" class="flex space-between row btns-msg f12">
              ...
              <div>
                ...
                <i class="iconfont icon-icon_shuju f12" style="color: #93BF88;" @click="$router.push({path: `/safetyEdu/listPublishArticleTotal`})"></i>
              </div>
            </div>
            <div>
              ...
              <!--<i class="iconfont icon-icon_cehui_caozuo f12 cfff"></i> 撤销-->
              <!--</el-button>-->
              <el-button type="primary" size="small" class="el-button--small-icon button-v2-rao b93BF88 " @click="del" :disabled="multipleSelection.length === 0">
          ...
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column label="操作" fixed="right" width="200">
              <template slot-scope="scope">
                ...
                <!--<i class="iconfont icon-icon_shuzhuangtyu ml5 f20 c999999" title="详情" @click="toTheRoute(`detail`, scope.row.articleId)"></i>-->
                <!--<i class="iconfont icon-icon_bianji ml5 f20 c999999" title="编辑" v-if="scope.row.status !== 'published'" @click="toTheRoute(`edit`, scope.row.articleId)"></i>-->
                <!--<i class="iconfont icon-icon_shanchu_caozuo ml5 f20 c999999" title="删除" @click="deleteRow(scope.row.articleId)"></i>-->
                <!--<i class="iconfont icon-icon_cehui_caozuo ml5 f20 c999999" title="撤回" v-if="scope.row.status === 'published'" @click="recall(scope.row.articleId)"></i>-->
                <!--<i class="iconfont icon-icon_zhiding ml5 f20 c999999" title="置顶" v-if="scope.row.isToTop !== 1 && scope.row.status === 'published'" @click="toTopHandle(scope.row.articleId)"></i>-->
                <!--<i class="iconfont icon-icon_quxiaozhiding ml5 f20 c999999" title="取消置顶" v-if="scope.row.isToTop===1" @click="cancelTop(scope.row.articleId)"></i>-->
                <!--<i class="iconfont icon-icon_shenhe ml5 f20 c999999" @click="check(scope.row.articleId)" title="审核"></i>-->
                <!--<el-button size="small" v-if="!isPush" :disabled="scope.row.entityOrgStatusCode !== 'editing'" type="primary"  @click="pushEntity(scope.row)">发布</el-button>
                ...
                <el-button size="small" v-if="!isPush" type="primary" @click.stop="toObject(scope.row.entityOrgId)" >组织对象</el-button>-->
              </template>
            </el-table-column>
          </el-table>
        </div>
...
export default {
  ...
  methods: {
    ...
    toTheRoute (type, id) {
      let path = `/safetyEdu/detailPublishArticle/${type}/${id}`
      console.log(path)
