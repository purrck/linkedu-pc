      ...
      <el-header style="height: auto">
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          <el-form-item label="年级编号:">
            <el-input v-model="searchForm.gradeNo" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="年级名称:">
            <el-input v-model="searchForm.gradeName" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="年级别名:">
            <el-input v-model="searchForm.gradeAliasName" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="gradeNo" label="年级编号" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="gradeName" label="年级名称" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="gradeAliasName" label="年级别名" sortable="custom" width="200"></el-table-column>
            ...
            <el-table-column label="操作" width="450" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           ...
                           @click.stop="toEdit(scope.row.gradeId)">
                  编辑
                </el-button>
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.gradeId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.gradeId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/basedata/detailGrade/add/' + 0;
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/basedata/detailGrade/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailGrade/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
