      ...
      <el-header style="height: auto">
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          <el-form-item label="名:">
            <el-input v-model="searchForm.firstName" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="用户类型:">
            <el-input v-model="searchForm.subjectType" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="手机号:">
            <el-input v-model="searchForm.mobilePhone" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="firstName" label="名" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="lastName" label="姓" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="nickname" label="昵称" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="gender" label="性别" sortable="custom" width="200">
              <template slot-scope="scope">
                <span v-if="scope.row.gender=='Y'">男</span>
                <span v-else>女</span>
              </template>
            </el-table-column>
            <el-table-column prop="headPicture" label="头像" sortable="custom" width="200">
              <template slot-scope="scope">
                <img :src="scope.row.headPicture" alt="" style="height: 50px" v-preview>
              </template>
            </el-table-column>
            <el-table-column prop="mobilePhone" label="手机号" sortable="custom" width="200"></el-table-column>
            <!--<el-table-column prop="coverImagePath" label="封面图" sortable="custom" width="200"></el-table-column>-->
            <el-table-column label="操作" width="450" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           class="tableEditButton"
                           @click.stop="toEdit(scope.row.subjectId)">
                  编辑
                </el-button>
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.subjectId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.subjectId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/basedata/detailAaSubject/add/' + 0;
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/basedata/detailAaSubject/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailAaSubject/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
