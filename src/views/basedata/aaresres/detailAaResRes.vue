        ...
        <el-form :label-position="'right'" class="edit-form"
          ...
          <el-col :span="12">
            <el-form-item label="上级资源 *  :" prop="parentResId">
              <el-input v-model="formData.parentResId" maxlength="32"></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
            ...
            <el-form :label-position="'right'" class="edit-form" label-width="165px"
              ...
              <el-col :span="12" v-if="formData.resResId">
                <el-form-item label="资源 :" prop="resResId">
                  {{formData.resResId}}
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12" v-if="formData.parentResId">
                <el-form-item label="上级资源 :" prop="parentResId">
                  {{formData.parentResId}}
                </el-form-item>
              </el-col>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          parentResId: [
            {required: true, message: "请您输入上级资源", trigger: "blur"},
            {max: 32, message: "最多能输入32个字", trigger: "blur"},
        ...
        if (this.pageState !== 'add') {
          api.getObj(paramsId).then(res => {
            if (res.data.resultCode === "000000") {
              ...
              this.formData.resResId = this.data.resResId;


              this.formData.resourcesId = this.data.resourcesId;


              this.formData.parentResId = this.data.parentResId;
