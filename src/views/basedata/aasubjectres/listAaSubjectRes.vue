      ...
      <el-header style="height: auto">
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          ...
          <el-form-item label="资源:">
            <el-input v-model="searchForm.resourcesId" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="resourcesId" label="资源" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="readAccess" label="读" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="createAccess" label="写" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="updateAccess" label="修改" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="deleteAccess" label="删除" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="effectiveDt" label="开启时间" sortable="custom"
                             width="200"></el-table-column>
            <el-table-column prop="expiryDt" label="截止时间" sortable="custom"
                             width="200"></el-table-column>
            <el-table-column prop="refGroupId" label="群组" sortable="custom" width="200"></el-table-column>
            <el-table-column label="操作" width="450" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           class="tableEditButton"
                           @click.stop="toEdit(scope.row.subjectResId)">
                  编辑
                </el-button>
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.subjectResId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.subjectResId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  import api from "./aasubjectresUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/safety/detailAaSubjectRes/add/' + 0;
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/safety/detailAaSubjectRes/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailAaSubjectRes/detail/' + id;
        this.$router.push({path: opath})
      },
