                    ...
                    <el-form  :label-position="'right'" class="edit-form"
                              label-width="200px" ref="formData" :inline="false" :model="formData" :rules="rules" size="small">
                                        ...
                                        <el-form-item label="喜欢人数 :" prop="approvedNum">
                                            <el-input v-model="formData.approvedNum" maxlength="11"></el-input>
                                        </el-form-item>
                                    </el-col>
                                        ...
                                        <el-form-item label="不喜欢人数 :" prop="opposedNum">
                                            <el-input v-model="formData.opposedNum" maxlength="11"></el-input>
                                        </el-form-item>
                                    </el-col>
                    ...
                    <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
                        ...
                        <el-form :label-position="'right'" class="edit-form" label-width="165px"
                                 :inline="true" :model="formData"  size="small">
                                            ...
                                            <el-form-item label="终端类型 :" prop="appdeviceTypeCode" :style="{'color':formData.appdeviceTypeCodeStr.split(';')[1]}">
                                            ...
                                            <el-form-item label="不喜欢人数 :" prop="opposedNum">
                                                {{formData.opposedNum}}
                                                                            ...
                                                                            <el-col :span="12"  v-if="formData.versioncode">
                        ...
                        if (res.data.resultCode === "000000") {
                            this.formData = res.data.data
                                        ...
                                        this.filePathFileList.push(filePathFileInfo);
                                                                    ...
                                                                    this.formData.releasedDt = this.data.releasedDt;
