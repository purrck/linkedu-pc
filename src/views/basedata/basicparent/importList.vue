<template>
  <el-container v-loading="isLoaded" element-loading-spinner="el-icon-loading"
                ...
                element-loading-background="rgba(0, 0, 0, 0.1)" style="min-height:800px">
    <div style="width:70%;margin:0 auto 0;">
      <el-main>
        <div v-if="state == 'all'">
              ...
              <div class="grid-content clearfix bg-grey">
                ...
                <el-col :span="18">
                  <div class="pr-20">
                    ...
                    <div class="text-right mt-10 fs-14"><a href="javascript:void(0)" @click="failHandler"
                                                           style="color:#838383">查看失败原因<img class="vm-3 pl-10"
                                                                                            src="~@/assets/img/icon_chakan.png"
                                                                                            width="15px"/></a></div>
                  </div>
                </el-col>
              </div>
                ...
                <el-col :span="18">
                  <div class="pr-20">
                    ...
                    <div class="text-right mt-10 fs-14">
                      <a :href="successDownloadUrl" style="color:#838383"><img class="vm-1 pr-10"
                                                                               src="~@/assets/img/icon_xiazai.png"
                                                                               width="13px"/>下载成功的数据</a>
                    </div>
                  </div>
                </el-col>
              </div>
              ...
              <div class="grid-content bg-grey">
                ...
                <el-col :span="18">
                  <div class="pr-20">
                    ...
                    <div class="text-right mt-10 fs-14">
                      <a :href="failDownloadUrl" style="color:#838383"><img src="~@/assets/img/icon_xiazai.png"
                                                                            width="13px" class="vm-1 pr-10"/>下载失败的数据</a>
                    </div>
                  </div>
                </el-col>
              </div>
              ...
              <div class="grid-content bg-grey">
                ...
                <el-col :span="18">
                  ...
                  <div class="text-right pr-20 mt-10 fs-14">
                    <a href="javascript:void(0)" style="color:#838383" @click="toImport"><img class="vm-1 pr-10"
                                                                                              src="~@/assets/img/icon_chongxindaoru.png"
                                                                                              width="13px"/>继续上传</a>
                  </div>
                </el-col>
              </div>
          ...
          <el-table :data="allList" class="table-rao checkbox-rao mt-15" ref="schooltable" tooltip-effect="dark"
        ...
        <div v-if="state == 'fail'">
          <div class="importHead"><img src="~@/assets/img/icon_chengong.png"
                                       style="vertical-align: -9px;padding-right:10px;" width="30"/>导入数据失败 <span
            style="color:#CB3946">{{failCount}}</span> 条
          </div>
          <el-table :data="failData" class="table-rao checkbox-rao" ref="schooltable" tooltip-effect="dark"
                    style="width: 100%" border>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toImport() {
        this.$router.push({path: `/basedata/basicparent/import`});
      },
      beforeUpload() {
