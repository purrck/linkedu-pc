                    ...
                    <el-form  :label-position="'right'" class="schoolForm-rao"
                              label-width="200px" ref="formData" :inline="false" :model="formData" :rules="rules" size="small">
                                        ...
                                        <el-form-item label="学校名 :" prop="schoolName">
                                            <el-input v-model="formData.schoolName" maxlength="32"></el-input>
                                        </el-form-item>
                                    </el-col>
                                        ...
                                        <el-form-item label="学段id :" prop="segmentId">
                                            <el-input v-model="formData.segmentId" maxlength="32"></el-input>
                                        </el-form-item>
                                    </el-col>
                                        ...
                                        <el-form-item label="学段名 :" prop="segmentName">
                                            <el-input v-model="formData.segmentName" maxlength="255"></el-input>
                                        </el-form-item>
                                    </el-col>
                                        ...
                                        <el-form-item label="年级id :" prop="gradeId">
                                            <el-input v-model="formData.gradeId" maxlength="32"></el-input>
                                        </el-form-item>
                                    </el-col>
                                        ...
                                        <el-form-item label="年级名 :" prop="gradeName">
                                            <el-input v-model="formData.gradeName" maxlength="16"></el-input>
                                        </el-form-item>
                                    </el-col>
