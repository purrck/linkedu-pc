      ...
      <el-header style="height: auto">
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          <el-form-item label="访问资源:">
            <el-input v-model="searchForm.resourceName" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="资源路径:">
            <el-input v-model="searchForm.resourcePath" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="资源类型:">
            <el-input v-model="searchForm.resourceType" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="resourceName" label="访问资源" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="resourcePath" label="资源路径" sortable="custom"></el-table-column>
            <el-table-column prop="resourceType" label="资源类型" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="effectiveFrom" label="有效时间" sortable="custom"
                             width="200"></el-table-column>
            <el-table-column label="操作" width="450" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           class="tableEditButton"
                           @click.stop="toEdit(scope.row.resourcesId)">
                  编辑
                </el-button>
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.resourcesId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.resourcesId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  import api from "./aaresourcesUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/basedata/detailAaResources/add/' + 0;
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/basedata/detailAaResources/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailAaResources/detail/' + id;
        this.$router.push({path: opath})
      },
      geteffectiveFromStr(row) {
        return row.effectiveFromStr;
      },
    }
  }
</script>
