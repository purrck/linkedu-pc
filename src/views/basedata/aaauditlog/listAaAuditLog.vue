      ...
      <el-header style="height: auto">
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          <el-form-item label="类:">
            <el-input v-model="searchForm.className" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="操作内容:">
            <el-input v-model="searchForm.message" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="操作级别:">
            <el-input v-model="searchForm.auditLevel" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="操作时间:">
            <el-date-picker v-model="searchForm.auditDate" type="date"
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="className" label="类" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="auditLevel" label="操作级别" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="auditDate" label="操作时间" sortable="custom"
                             width="200"></el-table-column>
            <el-table-column label="操作" width="450" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.auditLogId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.auditLogId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/basedata/detailAaAuditLog/add/' + 0;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailAaAuditLog/detail/' + id;
        this.$router.push({path: opath})
      },
      getauditDateStr(row) {
        return row.auditDateStr;
      },
    }
  }
</script>
