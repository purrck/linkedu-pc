    ...
    <div class="edit-box">
      <div v-if="pageState === 'add'" class='mh500'>
        ...
        <el-form :label-position="'right'" class="schoolForm-rao"
          ...
          <el-col :span="12">
            <el-form-item label="原密码 *  :" prop="oldPasswordId">
              <el-input v-model="formData.oldPasswordId" maxlength="32"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="原密码 *  :" prop="oldPassword">
              <el-input v-model="formData.oldPassword" maxlength="32"></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
            ...
            <el-form :label-position="'right'" class="edit-form" label-width="165px"
              ...
              <el-col :span="12" v-if="formData.oldPasswordId">
                <el-form-item label="原密码 :" prop="oldPasswordId">
                  {{formData.oldPasswordId}}
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12" v-if="formData.oldPassword">
                <el-form-item label="原密码 :" prop="oldPassword">
        ...
        if (this.pageState !== 'add') {
          api.getObj(paramsId).then(res => {
            if (res.data.resultCode === "000000") {
              ...
              this.formData.oldPasswordId = this.data.oldPasswordId;


              this.formData.subjectId = this.data.subjectId;


              this.formData.oldPassword = this.data.oldPassword;
