      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="oldPassword" label="原密码" sortable="custom"></el-table-column>
            <el-table-column label="操作" width="450" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.oldPasswordId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.oldPasswordId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  import api from "./aasubjectpwdhistoryUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/basedata/detailAaSubjectPwdHistory/add/' + 0;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailAaSubjectPwdHistory/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
