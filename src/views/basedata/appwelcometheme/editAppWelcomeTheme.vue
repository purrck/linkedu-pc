        ...
        <div class="edit-box">
                    ...
                    <el-form  :label-position="'right'" class="edit-form"
                              label-width="200px" ref="formData" :inline="false" :model="formData" :rules="rules" size="small">
                                                                    ...
                                                                    <el-col :span="12">
                                        <el-form-item label="应用欢迎主题 :" prop="welcomeThemeTitle">
                                            <el-input v-model="formData.welcomeThemeTitle" maxlength="128"></el-input>
                                        </el-form-item>
                                    </el-col>


                                                                    <el-col :span="12">
                                        <el-form-item label="是否当前应用 :" prop="isCurrent">
                                        ...
                                        <el-form-item label="更新时间 :" prop="refreshedDt">
                                            <el-date-picker v-model="formData.refreshedDt" type="datetime" placeholder="选择日期"
                                        ...
                                        <el-form-item label="应用 :" prop="appName">
                                            <el-input v-model="formData.appName" maxlength="128"></el-input>
                                        </el-form-item>
                                    </el-col>
                    ...
                    <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
                        ...
                        <el-form :label-position="'right'" class="edit-form" label-width="165px"
                                 :inline="true" :model="formData"  size="small">
                                                                            ...
                                                                            <el-col :span="12" v-if="formData.welcomeThemeTitle">
                                            <el-form-item label="应用欢迎主题 :" prop="welcomeThemeTitle">
                                                {{formData.welcomeThemeTitle}}
                                            </el-form-item>
                                        </el-col>
                                        ...
                                        <el-col :span="12"  v-if="formData.isCurrent">
                                            <el-form-item label="是否当前应用 :" prop="isCurrent">
                                                <el-switch v-model="formData.isCurrent == 'Y'" disabled></el-switch>
                                                                            ...
                                                                            <el-col :span="12"  v-if="formData.refreshedDt">
                                            <el-form-item label="更新时间 :" prop="refreshedDt">
                                                {{formData.refreshedDt}}
                                            </el-form-item>
                                        </el-col>
                            ...
                            <div class="menu-quickly">
                                <ul>
                                                                            <li>
                                            <router-link href="welcomeThemeId">
                                                <img src="~@/assets/img/menu_quickly/icon_classinfo.png"/>应用欢迎主题图集
                                            </router-link>
                                        </li>
                                                                    </ul>
                            </div>
                    ...
                    api.getObj(paramsId).then(res => {
                        if (res.data.resultCode === "000000") {
                            this.formData = res.data.data
                                                                    ...
                                                                    this.formData.refreshedDt = this.data.refreshedDt;
