    ...
    <div class="edit-box">
        ...
        <el-form :label-position="'right'" class="edit-form"
          ...
          <el-col :span="24">
            <el-form-item label="作息详细名称">
              <el-input class="input-v2-rao" style="width: 300px;" v-model="formData.timelineDetailName" placeholder="作息详细名称"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="开始时间 :" prop="">
              <el-time-picker v-model="formData.beginTime" value-format="HH:mm" placeholder="开始时间"></el-time-picker>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="结束时间 :" prop="">
              <el-time-picker v-model="formData.endTime" value-format="HH:mm" placeholder="结束时间"></el-time-picker>
            </el-form-item>
          </el-col>
          <el-col :span="24">
      ...
      <div v-if="pageState === 'edit'">
        ...
        <el-form :label-position="'right'" class="edit-form"
          ...
          <el-col :span="24">
            <el-form-item label="作息详细名称">
              <el-input style="width: 300px;" v-model="formData.timelineDetailName" placeholder="作息详细名称"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="开始时间 :" prop="">
...
export default {
  ...
  data () {
    return {
      formLoading: false,
      isLoaded: true,
      timelineId :this.$route.query.timelineId,
  ...
  methods: {
    submit (formName) {
      const set = this.$refs
      this.isLoaded = true
      this.formData.timelineId = this.timelineId
