  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/basedata/detailOrgSchoolTimelineDetailXs/add/' + 0+'?timelineId='+timelineId;
      ...
      toEdit(id) {
        let opath = '/basedata/detailOrgSchoolTimelineDetailXs/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailOrgSchoolTimelineDetailXs/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
