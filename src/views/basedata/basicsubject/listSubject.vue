      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="subjectName" label="学科名称" sortable="custom"></el-table-column>
            <el-table-column prop="subjectShortName" label="简称" sortable="custom"></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/basedata/detailSubject/add/' + 0;
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/basedata/detailSubject/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailSubject/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
