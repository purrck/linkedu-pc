      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="subjectId" label="用户id" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="groupId" label="群组id" sortable="custom"></el-table-column>
            <el-table-column label="操作" width="450" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.subjectGroupId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.subjectGroupId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/basedata/detailAaSubjectGroup/add/' + 0;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailAaSubjectGroup/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
