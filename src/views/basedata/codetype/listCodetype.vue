    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          ...
          <el-form-item label="字典类型描述:">
            <el-input v-model="searchForm.codetypeDesc" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="只读:">
            <el-input v-model="searchForm.readOnly" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="codetypeId" label="字典类型" sortable="custom" width="300"></el-table-column>
            <el-table-column prop="codetypeDesc" label="字典类型描述" sortable="custom"></el-table-column>
            <el-table-column prop="readOnly" label="只读" sortable="custom" width="200">
              <template slot-scope="scope">
                <el-switch v-model="scope.row.readOnly=='y'" disabled></el-switch>
              </template>
            </el-table-column>
            <el-table-column label="操作" width="450" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           ...
                           @click.stop="toEdit(scope.row.codetypeId)">
                  编辑
                </el-button>
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.codetypeId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.codetypeId)">删除
                </el-button>
                <el-button size="small" type="primary" @click="toInt(scope.row.codetypeId)">
                  字典数据
                </el-button>
              </template>
            </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/basedata/detailCodetype/add/' + 0;
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/basedata/detailCodetype/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailCodetype/detail/' + id;
        this.$router.push({path: opath})
      },
      toInt(id) {
        let opath = '/basedata/listCodeInt?codetypeId=' + id;
        this.$router.push({path: opath})
      },
    }
  }
