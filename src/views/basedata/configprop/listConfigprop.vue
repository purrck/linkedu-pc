      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="fileName" label="系统配置文焕" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="propKey" label="配置关键字" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="propDesc" label="配置描述" sortable="custom" width="400"></el-table-column>
            <el-table-column prop="propValue" label="配置内容" sortable="custom"></el-table-column>
            <el-table-column label="操作" width="300">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           class="tableEditButton"
                           @click.stop="toEdit(scope.row.propId)">
                  编辑
                </el-button>
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.propId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.propId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/basedata/editConfigprop/add/' + 0;
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/basedata/editConfigprop/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/editConfigprop/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
