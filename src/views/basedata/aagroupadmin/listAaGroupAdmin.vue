      ...
      <el-header style="height: auto">
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          ...
          <el-form-item label="管理类型:">
            <el-input v-model="searchForm.adminType" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="委托人:">
            <el-input v-model="searchForm.delegatorId" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="优先:">
            <el-input v-model="searchForm.precedence" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="adminType" label="管理类型" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="delegatorId" label="委托人" sortable="custom"></el-table-column>
            <el-table-column prop="precedence" label="优先" sortable="custom" width="200"></el-table-column>
            <el-table-column label="操作" width="450" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.adminId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.adminId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/basedata/detailAaGroupAdmin/add/' + 0;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailAaGroupAdmin/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
