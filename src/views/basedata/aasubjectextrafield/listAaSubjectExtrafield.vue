    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          <el-form-item label="学生姓名:" prop="subjectId">
            <el-input class="input-v2-rao" v-model="searchForm.userName" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="信息名:" prop="fieldDesc">
            <el-input class="input-v2-rao" v-model="searchForm.fieldDesc" maxlength="30"></el-input>
          </el-form-item>
          ...
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="userPreviewVO" align="center" label="学生" >
              <template slot-scope="scope">
                <div v-if="scope.row.userPreviewVO" class="flex row center">
                  <div class="pr-10">
                    <img :src="scope.row.userPreviewVO.headPicture" alt="" v-preview height="64" width="64">
                  </div>
                  <div class="flex space-between" style="height: 50px">
                    <span>{{scope.row.userPreviewVO.firstName}}</span>
            ...
            <el-table-column prop="fieldNameStr" align="center" label="信息名" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.fieldDesc" class="one-line">{{scope.row.fieldDesc}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
...
<script>
  import api from "./aasubjectextrafieldUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/basedata/detailAaSubjectExtrafield/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/basedata/AaSubjectExtrafieldTotal';
        // this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/basedata/detailAaSubjectExtrafield/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/basedata/detailAaSubjectExtrafield/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
