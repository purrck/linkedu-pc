    ...
    >
      <el-header style="height: auto">
        ...
        >
          ...
          <el-form-item label="进入时间:" prop="inDt" class="w140">
            <el-date-picker
              class="date-v2-rao"
              v-model="searchForm.inDt"
              type="date"
              value-format="yyyy-MM-dd HH:mm"
              placeholder="选择日期"
            ></el-date-picker>
          </el-form-item>
          <el-form-item label="出去时间:" prop="outDt" class="w140">
            <el-date-picker
              class="date-v2-rao"
              v-model="searchForm.outDt"
              type="date"
              value-format="yyyy-MM-dd HH:mm"
              placeholder="选择日期"
            ></el-date-picker>
          </el-form-item>
          <el-form-item label="异常停车:" prop="isParkingException" class="w140">
            <el-select
              class="select-v2-rao"
              v-model="searchForm.isParkingException"
              placeholder="请您选择"
            >
              <el-option
                v-for="isParkingExceptionItem in ynOptions"
                :key="isParkingExceptionItem.name"
                :label="isParkingExceptionItem.label"
                :value="isParkingExceptionItem.name"
              ></el-option>
            </el-select>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="inDt" label="进入时间" align="center" sortable="custom"></el-table-column>
            <!-- 进入时间 colName:in_dt sqlType:TIMESTAMP notnull:false -->
            <el-table-column prop="outDt" label="出去时间" align="center" sortable="custom"></el-table-column>
            <!-- 出去时间 colName:out_dt sqlType:TIMESTAMP notnull:false -->
            <el-table-column
              prop="isParkingException"
              label="异常停车"
              align="center"
              sortable="custom"
            >
              <template slot-scope="scope">
                <el-switch v-model="scope.row.isParkingException == 'Y'" disabled></el-switch>
              </template>
            </el-table-column>
            <!-- 异常停车 colName:is_parking_exception sqlType:VARCHAR notnull:false -->
            <el-table-column prop="imagePath" align="center" label="异常停车照片">
              <template slot-scope="scope">
            ...
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                <el-popover
                  ...
                  trigger="hover"
                >
                  <span slot="reference" @click.stop="toEdit(scope.row.carInoutId)">
                ...
                <el-popover
                  ...
                  trigger="hover"
                >
                  <span slot="reference" @click.stop="toDetail(scope.row.carInoutId)">
                ...
                <el-popover
                  ...
                  trigger="hover"
                >
                  <span slot="reference" @click.stop="rowDel(scope.row.carInoutId)">
...
export default {
  ...
  methods: {
    ...
    toAdd() {
      ...
      let opath = "/safetyManagement/detailTeacherCarInout/add/" + 0;
      this.$router.push({ path: opath });
    },
    toTotal() {
      let opath = "/safetyManagement/TeacherCarInoutTotal";
      this.$router.push({ path: opath });
    },
    toEdit(id) {
      let opath = "/safetyManagement/detailTeacherCarInout/edit/" + id;
      this.$router.push({ path: opath });
    },
    toDetail(id) {
      let opath = "/safetyManagement/detailTeacherCarInout/detail/" + id;
      this.$router.push({ path: opath });
    }
  }
};
