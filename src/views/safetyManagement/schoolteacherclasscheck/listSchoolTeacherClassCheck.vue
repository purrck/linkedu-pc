...
<template>
  <div class="SchoolTeacherClassCheck">
    <el-container
      v-loading="isLoaded"
    ...
    >
      <el-header style="height: auto">
        ...
        >
          ...
          <el-form-item label="开始时间:" prop="classBeginDt" class="w140">
            <el-date-picker
              class="date-v2-rao"
              v-model="searchForm.classBeginDt"
              type="date"
              value-format="yyyy-MM-dd HH:mm"
              placeholder="选择日期"
            ></el-date-picker>
          </el-form-item>
          <el-form-item label="结束时间:" prop="classEndDt" class="w140">
            <el-date-picker
              class="date-v2-rao"
              v-model="searchForm.classEndDt"
              type="date"
              value-format="yyyy-MM-dd HH:mm"
              placeholder="选择日期"
            ></el-date-picker>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="classBeginDt" label="开始时间" align="center" sortable="custom"></el-table-column>
            <!-- 开始时间 colName:class_begin_dt sqlType:TIMESTAMP notnull:false -->
            <el-table-column prop="classEndDt" label="结束时间" align="center" sortable="custom"></el-table-column>
            <!-- 结束时间 colName:class_end_dt sqlType:TIMESTAMP notnull:false -->
            ...
            <!-- 正常考勤 colName:is_normal sqlType:VARCHAR notnull:false -->
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                <el-popover
                  ...
                  trigger="hover"
                >
                  <span slot="reference" @click.stop="toEdit(scope.row.classCheckId)">
                ...
                <el-popover
                  ...
                  trigger="hover"
                >
                  <span slot="reference" @click.stop="toDetail(scope.row.classCheckId)">
                ...
                <el-popover
                  ...
                  trigger="hover"
                >
                  <span slot="reference" @click.stop="rowDel(scope.row.classCheckId)">
...
<script>
import api from "./schoolteacherclasscheckUrl";
...
export default {
  ...
  methods: {
    ...
    toAdd() {
      ...
      let opath = "/safetyManagement/detailSchoolTeacherClassCheck/add/" + 0;
      this.$router.push({ path: opath });
    },
    toTotal() {
      let opath = "/safetyManagement/SchoolTeacherClassCheckTotal";
      this.$router.push({ path: opath });
    },
    toEdit(id) {
      let opath = "/safetyManagement/detailSchoolTeacherClassCheck/edit/" + id;
      this.$router.push({ path: opath });
    },
    toDetail(id) {
      let opath =
        "/safetyManagement/detailSchoolTeacherClassCheck/detail/" + id;
      this.$router.push({ path: opath });
    }
  }
};
