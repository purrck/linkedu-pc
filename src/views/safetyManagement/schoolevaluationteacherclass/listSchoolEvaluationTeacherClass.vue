...
<template>
  <div class="SchoolEvaluationTeacherClass">
    <el-container
      v-loading="isLoaded"
            ...
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                <el-popover
                  ...
                  trigger="hover"
                >
                  <span slot="reference" @click.stop="toDetail(scope.row.evaluationTeacherClassId)">
                ...
                <el-popover
                  ...
                  trigger="hover"
                >
                  <span slot="reference" @click.stop="rowDel(scope.row.evaluationTeacherClassId)">
  ...
  methods: {
    ...
    handleSelectionChange(val) {
      this.multipleSelection = val.map(item => {
        return item.evaluationTeacherClassId;
      });
    },
    ...
    toAdd() {
      ...
      let opath =
        "/safetyManagement/detailSchoolEvaluationTeacherClass/add/" + 0;
      this.$router.push({ path: opath });
    },
    toTotal() {
      let opath = "/safetyManagement/SchoolEvaluationTeacherClassTotal";
      this.$router.push({ path: opath });
    },
    toDetail(id) {
      let opath =
        "/safetyManagement/detailSchoolEvaluationTeacherClass/detail/" + id;
      this.$router.push({ path: opath });
    }
  }
};
