...
export default {
  ...
  methods: {
    ...
    toAdd() {
      ...
      let opath = "/securityReminder/detailSchoolSecurityMessage/add/" + 0;
      this.$router.push({ path: opath });
    },
    toTotal() {
      let opath = "/securityReminder/SchoolSecurityMessageTotal";
      this.$router.push({ path: opath });
    },
    toEdit(id) {
      let opath = "/securityReminder/detailSchoolSecurityMessage/edit/" + id;
      this.$router.push({ path: opath });
    },
    toDetail(id) {
      let opath = "/securityReminder/detailSchoolSecurityMessage/detail/" + id;
      this.$router.push({ path: opath });
    },
    toAnother(id, path) {
