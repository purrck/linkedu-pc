...
export default {
  ...
  methods: {
    ...
    toAdd() {
      ...
      let opath = "/securityReminder/detailStudentGroup/add/" + 0;
      this.$router.push({ path: opath });
    },
    toTotal() {
      let opath = "/securityReminder/StudentGroupTotal";
      this.$router.push({ path: opath });
    },
    toEdit(id) {
      let opath = "/securityReminder/detailStudentGroup/edit/" + id;
      this.$router.push({ path: opath });
    },
    toDetail(id) {
      let opath = "/securityReminder/detailStudentGroup/detail/" + id;
      this.$router.push({ path: opath });
    },
    toAnother(id, path) {
      let opath = "/securityReminder/" + path + "?groupId=" + id;
      this.$router.push({ path: opath });
    }
  }
};
