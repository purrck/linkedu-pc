    ...
    >
      <el-header style="height: auto">
        <el-form
          ...
          class="select-form"
        >
          <el-form-item label="任务学生:" prop="taskUserId" class="w140">
            <el-input class="input-v2-rao" v-model="searchForm.taskUserId" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="教师确认:" prop="isTeacherConfirm" class="w140">
            <el-select
              class="select-v2-rao"
              v-model="searchForm.isTeacherConfirm"
              placeholder="请您选择"
            >
              <el-option
                v-for="isTeacherConfirmItem in ynOptions"
                :key="isTeacherConfirmItem.name"
                :label="isTeacherConfirmItem.label"
                :value="isTeacherConfirmItem.name"
              ></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="教师评语:" prop="teacherComment" class="w140">
            <el-input class="input-v2-rao" v-model="searchForm.teacherComment" maxlength="30"></el-input>
          </el-form-item>
          ...
          <el-form-item label="家长评语:" prop="parentComment" class="w140">
            <el-input class="input-v2-rao" v-model="searchForm.parentComment" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="doneTaskDt" align="center" label="完成任务时间" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.doneTaskDt" class="one-line">{{scope.row.doneTaskDt}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="filePath" align="center" label="文件" sortable="custom">
              <template slot-scope="scope">
            ...
            <el-table-column prop="parentComment" align="center" label="家长评语" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.parentComment" class="one-line">{{scope.row.parentComment}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
            ...
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                <el-popover
                  ...
                  trigger="hover"
                >
                  <span slot="reference" @click.stop="toEdit(scope.row.taskUserHisId)">
                ...
                <el-popover
                  ...
                  trigger="hover"
                >
                  <span slot="reference" @click.stop="toDetail(scope.row.taskUserHisId)">
                ...
                <el-popover
                  ...
                  trigger="hover"
                >
                  <span slot="reference" @click.stop="rowDel(scope.row.taskUserHisId)">
...
export default {
  ...
  methods: {
    ...
    toAdd() {
      ...
      let opath = "/securityReminder/detailSchoolTaskUserHis/add/" + 0;
      this.$router.push({ path: opath });
    },
    toTotal() {
      let opath = "/securityReminder/SchoolTaskUserHisTotal";
      this.$router.push({ path: opath });
    },
    toEdit(id) {
      let opath = "/securityReminder/detailSchoolTaskUserHis/edit/" + id;
      this.$router.push({ path: opath });
    },
    toDetail(id) {
      let opath = "/securityReminder/detailSchoolTaskUserHis/detail/" + id;
      this.$router.push({ path: opath });
    }
  }
};
