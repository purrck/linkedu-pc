  ...
  export default {
    ...
    methods: {
      ...
      dialogDeleteCancelHandler() {
        ...
        let opath = '/securityReminder/detailPersonalArticleRecommend/add/' + 0;
        this.$router.push({path: opath})
      },
            toTotal (){
        let opath = '/securityReminder/PersonalArticleRecommendTotal';
        this.$router.push({path: opath})
      },
            toEdit(id) {
        let opath = '/securityReminder/detailPersonalArticleRecommend/edit/' + id;
        this.$router.push({path: opath})
      },
                  toDetail(id) {
        let opath = '/securityReminder/detailPersonalArticleRecommend/detail/' + id;
        this.$router.push({path: opath})
      },
                }
  }
