          ...
          <el-form :label-position="'right'" class="edit-form"
                  ...
                  <el-col :span="24">
                    <el-form-item label="状态 :" prop="personalArticleStatusCode">
                      <el-select class="select-v2-rao" v-model="formData.personalArticleStatusCode" placeholder="请您选择">
                        <el-option v-for="personalArticleStatusCodeItem in personalArticleStatusCodeOptions"
                                   :key="personalArticleStatusCodeItem.name"
                                   :label="personalArticleStatusCodeItem.label" :value="personalArticleStatusCodeItem.name">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                  <el-col :span="24">
                    <el-form-item label="个人置顶 :" prop="isPersonalRecommend">
                      <el-select class="select-v2-rao" v-model="formData.isPersonalRecommend" placeholder="请您选择">
                        <el-option v-for="isPersonalRecommendItem in ynOptions" :key="isPersonalRecommendItem.name"
                                   :label="isPersonalRecommendItem.label" :value="isPersonalRecommendItem.name">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                  ...
                  <el-col :span="24">
                    <el-form-item label="阅读 :" prop="readTimesNum">
                      <el-input class="input-v2-rao" v-model="formData.readTimesNum"
                                maxlength="11"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="24">
                    <el-form-item label="点赞 :" prop="praiseTimesNum">
                      <el-input class="input-v2-rao" v-model="formData.praiseTimesNum"
                                maxlength="11"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="24">
                    <el-form-item label="踩 :" prop="dislikeTimesNum">
                      <el-input class="input-v2-rao" v-model="formData.dislikeTimesNum"
                                maxlength="11"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="24">
                    <el-form-item label="评论 :" prop="commentTimesNum">
                      <el-input class="input-v2-rao" v-model="formData.commentTimesNum"
                                maxlength="11"></el-input>
                    </el-form-item>
                  </el-col>
          ...
          <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
            ...
            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
              <div class="menu-quickly">
                <ul>
                  <li>
                    <router-link :to="`/basedata/listPersonalArticleRecommend?articleId=`+
                                  formData.articleId">
