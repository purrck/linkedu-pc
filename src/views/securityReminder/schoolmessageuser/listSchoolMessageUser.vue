  ...
  export default {
    ...
    methods: {
      ...
      dialogDeleteCancelHandler() {
        ...
        let opath = '/securityReminder/detailSchoolMessageUser/add/' + 0;
        this.$router.push({path: opath})
      },
            toTotal (){
        let opath = '/securityReminder/SchoolMessageUserTotal';
        this.$router.push({path: opath})
      },
            toEdit(id) {
        let opath = '/securityReminder/detailSchoolMessageUser/edit/' + id;
        this.$router.push({path: opath})
      },
                  toDetail(id) {
        let opath = '/securityReminder/detailSchoolMessageUser/detail/' + id;
        this.$router.push({path: opath})
      },
                }
  }
