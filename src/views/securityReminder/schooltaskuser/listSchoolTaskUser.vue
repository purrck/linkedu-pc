    ...
    >
      <el-header style="height: auto">
        <el-form
          ...
          class="select-form"
        >
          <el-form-item label="任务学生id:" prop="taskUserId" class="w140">
...
export default {
  ...
  methods: {
    ...
    toAdd() {
      ...
      let opath = "/securityReminder/detailSchoolTaskUser/add/" + 0;
      this.$router.push({ path: opath });
    },
    toTotal() {
      let opath = "/securityReminder/SchoolTaskUserTotal";
      this.$router.push({ path: opath });
    },
    toEdit(id) {
      let opath = "/securityReminder/detailSchoolTaskUser/edit/" + id;
      this.$router.push({ path: opath });
    },
    toDetail(id) {
      let opath = "/securityReminder/detailSchoolTaskUser/detail/" + id;
      this.$router.push({ path: opath });
    },
    toAnother(id, path) {
      let opath = "/securityReminder/" + path + "?taskUserId=" + id;
      this.$router.push({ path: opath });
    }
  }
};
