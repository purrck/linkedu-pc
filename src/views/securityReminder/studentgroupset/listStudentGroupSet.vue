...
export default {
  ...
  methods: {
    ...
    toAdd() {
      ...
      let opath = "/securityReminder/detailStudentGroupSet/add/" + 0;
      this.$router.push({ path: opath });
    },
    toTotal() {
      let opath = "/securityReminder/StudentGroupSetTotal";
      this.$router.push({ path: opath });
    },
    toEdit(id) {
      let opath = "/securityReminder/detailStudentGroupSet/edit/" + id;
      this.$router.push({ path: opath });
    },
    toDetail(id) {
      let opath = "/securityReminder/detailStudentGroupSet/detail/" + id;
      this.$router.push({ path: opath });
    },
    toAnother(id, path) {
      let opath = "/securityReminder/" + path + "?setId=" + id;
      this.$router.push({ path: opath });
    }
  }
};
