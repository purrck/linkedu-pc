    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          ...
          <el-form-item label="信息实体版本:">
            <el-input v-model="searchForm.entityVersion" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="selected-box mb-15">
          <el-row>
            ...
            <el-col :span="12">
              <!--@click="$router.push('/safety/entityapproveTotal')"-->
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="preStatus" label="审批前状态" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.preStatus">{{scope.row.preStatus}}</div>
                <div v-else>N/A</div>
              </template>
            </el-table-column>
            <el-table-column prop="nextStatus" label="审批后状态" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.nextStatus">{{scope.row.nextStatus}}</div>
                <div v-else>N/A</div>
              </template>
            </el-table-column>
            <el-table-column prop="approveContent" label="审批信息" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.approveContent">{{scope.row.approveContent}}</div>
                <div v-else>N/A</div>
              </template>
            </el-table-column>
            <el-table-column prop="approvedDt" label="审批时间" sortable="custom"
                             width="200"></el-table-column>
            <el-table-column prop="userName" label="审批人" sortable="custom">
              <template slot-scope="scope">
            ...
            <el-table-column label="操作" width="350" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           ...
                           @click.stop="toEdit(scope.row.approveId)">
                  编辑
                </el-button>
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.approveId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.approveId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/safety/detailEntityApprove/add/' + 0;
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/safety/detailEntityApprove/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailEntityApprove/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
