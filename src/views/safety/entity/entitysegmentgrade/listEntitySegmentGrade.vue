      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="gradeName" label="年级" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="segmentName" label="学段" sortable="custom"></el-table-column>
            ...
            <el-table-column label="操作" width="280" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.segmentGradeId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.segmentGradeId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  import api from "./entitysegmentgradeUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/safety/detailEntitySegmentGrade/add/' + 0;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailEntitySegmentGrade/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
