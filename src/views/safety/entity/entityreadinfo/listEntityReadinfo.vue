      ...
      <el-header style="height: auto">
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          ...
          <el-form-item label="浏览时间:">
            <el-date-picker v-model="searchForm.readDt"
                            type="date"
                            placeholder="浏览时间"
      ...
      <el-main class="pt-15">
        ...
        <div class="selected-box mb-15">
          <el-row>
            ...
            <el-col :span="12">
              <div class="result text-right" @click="$router.push('/safety/entityreadinfoTotal')">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="userName" label="用户" sortable="custom"></el-table-column>

            <el-table-column prop="entityName" label="信息内容" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="entityTypeName" label="信息类别" sortable="custom" width="200"></el-table-column>

            <el-table-column prop="readDt" label="浏览时间" sortable="custom"
                             width="300"></el-table-column>
            <el-table-column prop="readTimes" label="浏览次数" sortable="custom" width="100"></el-table-column>
            <el-table-column prop="updatedDt" label="离开时间" sortable="custom"
                             width="300"></el-table-column>
            <el-table-column label="操作" width="200" fixed="right" align="center">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.readId)">
                  详情
                </el-button>
                <!--<el-button size="small" type="danger"-->
                <!--@click="rowDel(scope.row.readId)">删除-->
                <!--</el-button>-->
              </template>
            </el-table-column>
          </el-table>
  ...
  export default {
    data() {
      return {
        ...
        readByAppCodeOptions: [{'label': '全部', 'name': ''}],
        readByAppCodeValue: null,
        form: {
          entityId:
            null,
          userId:
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/safety/detailEntityReadinfo/add/' + 0
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailEntityReadinfo/detail/' + id
        this.$router.push({path: opath})
      },
      getreadDtStr(row) {
        return row.readDtStr
      },
      getleaveDtStr(row) {
        return row.leaveDtStr
      },
    }
  }
</script>
