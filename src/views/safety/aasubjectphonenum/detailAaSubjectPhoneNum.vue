    ...
    <div class="edit-box">
      ...
      <div v-if="pageState === 'edit'">
        ...
        <el-form :label-position="'right'" class="schoolForm-rao"
          ...
          <el-col :span="12">
            <el-form-item label="手机号状态 :" prop="phonenumStatusCode">
              <el-select v-model="formData.phonenumStatusCode" placeholder="请您选择">
                <el-option v-for="phonenumStatusCodeItem in phonenumStatusCodeOptions"
                           :key="phonenumStatusCodeItem.name"
                           :label="phonenumStatusCodeItem.label" :value="phonenumStatusCodeItem.name">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
            ...
            <el-form :label-position="'right'" class="schoolForm-rao schoolForm-detail-rao" label-width="165px"
              ...
              <el-col :span="12" v-if="formData.phonenumId">
                <el-form-item label="手机号id :" prop="phonenumId">
                  {{formData.phonenumId}}
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12" v-if="formData.phoneNum">
              ...
              <el-col :span="12">
                <el-form-item label="手机号状态 :" prop="phonenumStatusCode"
                              v-if="formData.phonenumStatusCodeStr"
                              :style="{'color':formData.phonenumStatusCodeStr.split(';')[1]}">
                  {{formData.phonenumStatusCodeStr.split(';')[0]}}
                </el-form-item>
              </el-col>
  ...
  export default {
    data() {
      return {
        ...
        phonenumStatusCodeOptions: [{"label": "全部", "name": ""}], phonenumStatusCode: null,
        data: "",
        formData: {
          phonenumId: '',
          effectiveDt: "",
