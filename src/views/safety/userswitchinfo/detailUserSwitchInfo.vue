                ...
                <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
                    ...
                    <el-form :label-position="'right'" class="schoolForm-rao schoolForm-detail-rao" label-width="165px"
                             :inline="true" :model="formData"  size="small">
                                    ...
                                    <el-col :span="12" v-if="formData.userSwitchId">
                                        <el-form-item label="id :" prop="userSwitchId">
                                            {{formData.userSwitchId}}
                                        </el-form-item>
                                    </el-col>
                                    ...
                                    <el-col :span="12">
                                        <el-form-item label="开放 :" prop="isSwitchValue">
                                            <div v-if="formData.isSwitchValue == 'Y'">
...
<script>
    ...
    export default {
        ...
        return {
            ...
            ynOptions :[{"label": "全部", "name": ""}], isSwitchValue : null,
            data :"",
            formData:{
            userSwitchId :null,
            isSwitchValue :"",
                ...
                if (this.pageState !== 'add') {
                    api.getObj(paramsId).then(res => {
                        if (res.data.resultCode === '000000') {
                            ...
                            this.formData.userSwitchId = this.data.userSwitchId;
                            ...
                            this.formData.isSwitchValue = this.data.isSwitchValue;
