      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="isSwitchValue" label="开放" sortable="custom">
              <template slot-scope="scope">
                <div>
                  <el-switch v-model="scope.row.isSwitchValue == 'Y'" disabled></el-switch>
                </div>
            ...
            <el-table-column label="操作" width="280" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.userSwitchId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.userSwitchId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  import api from "./userswitchinfoUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/safety/detailUserSwitchInfo/add/' + 0;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailUserSwitchInfo/detail/' + id;
        this.$router.push({path: opath})
      },
      getisSwitchValueStr(row) {
        return row.isSwitchValueStr;
      },
    }
  }
</script>
