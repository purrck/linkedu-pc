        ...
        if (this.pageState !== 'add') {
          api.getObj(paramsId).then(res => {
            if (res.data.resultCode === '000000') {
              ...
              this.formData.isNeedAcc = this.data.isNeedAcc;


              this.formData.uriTypeCode = this.data.uriTypeCode;


              this.formData.description = this.data.description;


              this.formData.paramsRules = this.data.paramsRules;


              this.formData.moduleName = this.data.moduleName;
