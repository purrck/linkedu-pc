  ...
  <div>
    <div class="edit-box">
        ...
        <el-row>
          <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
            ...
            <el-form :label-position="'right'" label-width="165px"
              ...
              <el-col :span="12" v-if="formData.meetingTopic">
                <el-form-item label="会议主题 :" prop="meetingTopic">
              ...
              <el-col :span="24">
                <el-form-item label="视频 :" prop="meetingVideo">
                  <video width="500" height="240" controls ref="meetingVideoVideo">
      ...
      <div class="text-center mb-15">
        ...
        <el-button type="primary" class="mr80" :loading="formLoading" size="small"
                   @click="goBack">确认
        </el-button>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 地图搜索
      localGpsSearch(e) {
        this.localGpsKeyword = this.formData.localGps;
