      ...
      <el-header style="height: auto">
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          <el-form-item label="消息模板:">
            <el-input v-model="searchForm.templateName" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="templateName" label="消息模板" sortable="custom"></el-table-column>
            <el-table-column label="操作" fixed="right" width="300">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           class="tableEditButton"
                           @click.stop="toEdit(scope.row.templateId)">
                  编辑
                </el-button>
                <el-button size="small" type="primary"
                ...
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.templateId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/safety/editMessagetp/add/' + 0
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/safety/editMessagetp/edit/' + id
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/editMessagetp/detail/' + id
        this.$router.push({path: opath})
      },
    }
  }
