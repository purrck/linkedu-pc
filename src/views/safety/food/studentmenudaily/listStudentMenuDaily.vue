      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="schoolName" align="center" label="学校" sortable="custom">
              <template slot-scope="scope">
              ...
              <template slot-scope="scope">
                <div class="flex  row">
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.studentMenuDailyId)"><i
                  ...
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.studentMenuDailyId)"><i
    ...
    methods: {
      ...
      handleSelectionChange(val) {
        this.multipleSelection = val.map(item => {
          return item.studentMenuDailyId
        });
      },
      ...
      toAdd() {
        ...
        let opath = '/safety/detailStudentMenuDaily/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/safety/StudentMenuDailyTotal';
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailStudentMenuDaily/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
