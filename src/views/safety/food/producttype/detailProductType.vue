    ...
    <div class="edit-box">
        <div v-if="pageState === 'add'">
          ...
          <el-form :label-position="'right'" class="edit-form"
                  ...
                  <!--<el-col :span="24">-->
                    <!--<el-form-item label="上级类型 :" prop="productTypeParentId">-->
                      <!--<el-input class="input-v2-rao" v-model="formData.productTypeParentId"-->
                                <!--maxlength="32"></el-input>-->
                    <!--</el-form-item>-->
                  <!--</el-col>-->
                  <!--<el-col :span="24">-->
                    <!--<el-form-item label="上级类型 :" prop="productTypeParentName">-->
                      <!--<el-input class="input-v2-rao" v-model="formData.productTypeParentName"-->
                                <!--maxlength="32"></el-input>-->
                    <!--</el-form-item>-->
                  <!--</el-col>-->
          </el-form>
          ...
          <el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
            ...
            <el-form :label-position="'right'" label-width="120px"
              ...
              <div class="p100">
                ...
                <div class="detail-item-v2">
                        ...
                        <!--<div class="p50" v-if="formData.productTypeParentId">-->
                          <!--<el-form-item label="上级类型 :" prop="productTypeParentId">-->
                            <!--<span v-if="formData.productTypeParentId">{{formData.productTypeParentId}}</span>-->
                          <!--</el-form-item>-->
                        <!--</div>-->
                        <!--<div class="p50" v-if="formData.productTypeParentName">-->
                          <!--<el-form-item label="上级类型 :" prop="productTypeParentName">-->
                            <!--<span v-if="formData.productTypeParentName">{{formData.productTypeParentName}}</span>-->
                          <!--</el-form-item>-->
                        <!--</div>-->
                </div>
              </div>
            ...
            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
              <div class="menu-quickly">
                <ul>
                  <li>
                    <router-link :to="`/basedata/listProductInfo?productTypeId=`+
                                  formData.productTypeId">
                      <i class="iconfont icon-icon_liebiao"></i>食材商品
                    </router-link>
                  </li>
                </ul>
              </div>
    ...
    data() {
      return {
        ...
        rules : {
              productTypeName :
              [
                  {required: true, message: "请您输入食品类型", trigger: "blur"},
