      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="productName" align="center" label="食品商品" sortable="custom">
              ...
              <template slot-scope="scope">
                <div class="flex  row">
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                    <span slot="reference"
                          @click.stop="toEdit(scope.row.productId)"><i
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.productId)"><i
                  ...
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.productId)"><i
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/safety/detailProductInfo/add/' + 0;
        this.$router.push({path: opath,query:this.$route.query})
      },
      toTotal() {
        let opath = '/safety/ProductInfoTotal';
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/safety/detailProductInfo/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailProductInfo/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
