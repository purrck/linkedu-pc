    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          <el-form-item label="食品供应商:" prop="productSupplierId">
            <el-input class="input-v2-rao" v-model="searchForm.productSupplierId" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="食品供应商:" prop="productSupplierName">
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="productSupplierName" align="center" label="食品供应商" sortable="custom">
              ...
              <template slot-scope="scope">
                <div class="flex  row">
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                    <span slot="reference"
                          @click.stop="toEdit(scope.row.productSupplierId)"><i
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.productSupplierId)"><i
                  ...
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.productSupplierId)"><i
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="食材商品" trigger="hover">
                      <span slot="reference" @click.stop="toAnother(scope.row.productSupplierId ,`listProductInfo`)"><i
...
<script>
  import api from "./productsupplierUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/safety/detailProductSupplier/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/safety/ProductSupplierTotal';
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/safety/detailProductSupplier/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailProductSupplier/detail/' + id;
        this.$router.push({path: opath})
      },
      toAnother(id, path) {
        let opath = '/safety/' + path + '?productSupplierId=' + id;
        this.$router.push({path: opath})
      },
    }
  }
