      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="menuDayDt" label="日期" align="center" sortable="custom"></el-table-column>
            ...
            <el-table-column prop="usedStudentNum" align="center" label="学生点菜数" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.usedStudentNum" class="one-line">{{scope.row.usedStudentNum}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
              ...
              <template slot-scope="scope">
                <div class="flex  row">
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                    <span slot="reference"
                          @click.stop="toEdit(scope.row.schoolMenuDailyId)"><i
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.schoolMenuDailyId)"><i
                  ...
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.schoolMenuDailyId)"><i
...
<script>
  import api from "./schoolmenudailyUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/safety/detailSchoolMenuDaily/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/safety/SchoolMenuDailyTotal';
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/safety/detailSchoolMenuDaily/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailSchoolMenuDaily/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
