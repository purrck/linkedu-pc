      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="productTypeName" align="center" label="食品" sortable="custom">
              <template slot-scope="scope">
              ...
              <template slot-scope="scope">
                <div class="flex  row">
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="编辑" trigger="hover">
                    <span slot="reference"
                          @click.stop="toEdit(scope.row.schoolMenuProductId)"><i
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.schoolMenuProductId)"><i
                  ...
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.schoolMenuProductId)"><i
    ...
    methods: {
      ...
      handleSelectionChange(val) {
        this.multipleSelection = val.map(item => {
          return item.schoolMenuProductId
        });
      },
      ...
      toAdd() {
        ...
        let opath = '/safety/detailSchoolMenuProduct/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/safety/SchoolMenuProductTotal';
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/safety/detailSchoolMenuProduct/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailSchoolMenuProduct/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
