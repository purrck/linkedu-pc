      ...
      <el-main class="pt-15">
          ...
          <el-col :span="24" class="text-left mb-10 flex row btns x-center space-between">
            ...
            <div class="flex space-between row btns-msg f12">
              <div>
                ...
                <span class="c707070">已选择 <span class="bold b93BF88">{{multipleSelection.length}}</span>项</span>
              </div>
              <div>
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="userName" label="签到人" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.userName" class="one-line">{{scope.row.userName}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
            <el-table-column prop="checkedDt" label="签到时间" sortable="custom"></el-table-column>
...
<script>
  import api from "./meetingchecklistUrl";
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        ...
        let opath = '/safety/detailMeetingChecklist/add/' + 0;
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/safety/detailMeetingChecklist/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailMeetingChecklist/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
