      ...
      <el-header style="height: auto">
        ...
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small" class="select-form">
          <el-form-item label="菜单:" prop="menuName">
            <el-input class="input-v2-rao" v-model="searchForm.menuName" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="陪餐时间:" prop="menuDayDt">
            <el-date-picker class="date-v2-rao" v-model="searchForm.menuDayDt" type="date"
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="menuName" align="center" label="菜单" sortable="custom">
              <template slot-scope="scope">
                <div v-if="scope.row.menuName" class="one-line">{{scope.row.menuName}}</div>
                <div v-else>无</div>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="menuDayDt" label="陪餐时间" align="center" sortable="custom"></el-table-column>
              ...
              <template slot-scope="scope">
                <div class="flex  row">
                  ...
                  <el-popover placement="top-start" popper-class="popover-v2-rao" title="查看" trigger="hover">
                    <span slot="reference"
                          @click.stop="toDetail(scope.row.teacherMenuDailyId)"><i
                  ...
                  <span slot="reference"
                        @click.stop="rowDel(scope.row.teacherMenuDailyId)"><i
    ...
    methods: {
      ...
      handleSelectionChange(val) {
        this.multipleSelection = val.map(item => {
          return item.teacherMenuDailyId
        });
      },
      ...
      toAdd() {
        ...
        let opath = '/safety/detailTeacherMenuDaily/add/' + 0;
        this.$router.push({path: opath})
      },
      toTotal() {
        let opath = '/safety/TeacherMenuDailyTotal';
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailTeacherMenuDaily/detail/' + id;
        this.$router.push({path: opath})
      },
    }
  }
