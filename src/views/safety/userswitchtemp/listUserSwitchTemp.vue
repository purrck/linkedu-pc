      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="switchName" label="开关" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="switchKey" label="开关key" sortable="custom" width="200"></el-table-column>
            <el-table-column prop="isSwitchDefValue" label="开关默认" sortable="custom">
              <template slot-scope="scope">
                <div>
                  <el-switch v-model="scope.row.isSwitchDefValue == 'Y'" disabled></el-switch>
                </div>
            ...
            <el-table-column label="操作" width="280" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           ...
                           @click.stop="toEdit(scope.row.switchId)">
                  编辑
                </el-button>
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.switchId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.switchId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toAdd() {
        let opath = '/safety/detailUserSwitchTemp/add/' + 0;
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/safety/detailUserSwitchTemp/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailUserSwitchTemp/detail/' + id;
        this.$router.push({path: opath})
      },
      getisSwitchDefValueStr(row) {
        return row.isSwitchDefValueStr;
      },
    }
  }
</script>
