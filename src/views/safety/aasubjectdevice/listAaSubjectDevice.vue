      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="macId" label="设备唯一id" sortable="custom" width="200"></el-table-column>
            ...
            <el-table-column label="设备状态">
              <template slot-scope="scope">
                <span :class="scope.row.deviceStatusCode" :style="{color:scope.row.deviceStatusCodeStr.split(';')[1]}">{{scope.row.deviceStatusCodeStr.split(';')[0]}}</span>
              </template>
            </el-table-column>
            <el-table-column prop="lastLoginDt" label="上次登录时间" sortable="custom"
                             width="200"></el-table-column>
            <el-table-column prop="mobileModel" label="设备型号" sortable="custom" width="200"></el-table-column>
            <el-table-column label="操作" width="280" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           class="tableEditButton"
                           @click.stop="toEdit(scope.row.deviceId)">
                  编辑
                </el-button>
                <el-button size="small" type="primary"
                ...
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.deviceId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
  ...
  export default {
    data() {
      return {
        ...
        deviceStatusCodeOptions: [{"label": "全部", "name": ""}],
        deviceStatusCodeValue: null,
        form: {},
        searchForm: {}
        ,
        data: "",
   ...
   this.params.page = currentPage
      ...
      toAdd() {
        let opath = '/safety/detailAaSubjectDevice/add/' + 0;
        this.$router.push({path: opath})
      },
      toEdit(id) {
        let opath = '/safety/detailAaSubjectDevice/edit/' + id;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailAaSubjectDevice/detail/' + id;
        this.$router.push({path: opath})
      },
      ...
      getdeviceStatusCodeStr(row) {
        return row.deviceStatusCodeStr;
      },
