        ...
        <el-form :label-position="'right'" class="w520"
          ...
          <el-col :span="24">
            <el-form-item label="隐患标题 :">
              <div>{{this.$route.query.dangerTitle}}</div>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="图片">
              <upload v-on:uploadData="uploadData" :imagelist="formData.imagePathList" :many="3"></upload>
            </el-form-item>
          </el-col>
        ...
        <el-form :label-position="'right'" class="w520"
          ...
          <!--<el-col>-->
            <!--<el-form-item label="处理人">-->
              <!--<el-input v-model="formData.processUserName" placeholder="处理人"></el-input>-->
            <!--</el-form-item>-->
          <!--</el-col>-->
            ...
            <el-form :label-position="'right'" label-width="120px"
              ...
              <div class="p100">
                ...
                <div class="detail-item-v2">
                  ...
                  <div class="p33">
                    <el-form-item label="处理人 :" prop="processTitle">
                      <span>{{formData.processUserName}}</span>
                    </el-form-item>
                  </div>
                  <!--<div class="p33" v-if="formData.processContent">-->
                  <!--<el-form-item label="处理内容 :" prop="processContent">-->
                  <!--<span v-if="formData.processContent">{{formData.processContent}}</span>-->
                  <!--</el-form-item>-->
                  <!--</div>-->
                  <div class="p33">
                    <el-form-item label="处理时间 :" prop="processDt">
                      <span> {{formData.processDt}}</span>
                    </el-form-item>
                  </div>
                </div>
              </div>
              ...
              <div class="p100">
                ...
                <div class="detail-item-v2" style="color: #707070;">
                  <p v-html="formData.processContent"></p>
                </div>
              </div>
            </el-form>
          </el-col>
...
export default {
  ...
  data () {
    return {
      ...
      formData: {
        ...
        processTitle: this.$route.query.dangerTitle,
        processContent: '',
        imagePathList: '',
      },
      pickTime: {
  ...
  methods: {
    uploadData(res){
      this.formData.imagePathList = res;
    },
    submit (formName) {
      const set = this.$refs
      this.isLoaded = true
