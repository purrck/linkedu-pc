    ...
    <el-container v-loading="isLoaded" element-loading-custom-class="home-loading"
      ...
      <el-header style="height: auto">
        <el-form ref="searchForm" :model="searchForm" :inline="true" size="small">
          <el-form-item label="登录值:">
            <el-input v-model="searchForm.loginValue" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="登录名:">
            <el-input v-model="searchForm.loginName" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="其他认证平台:">
            <el-select v-model="searchForm.otherLoginCodeValue" placeholder="请您选择">
              <el-option v-for="otherLoginCodeItem in otherLoginCodeOptions"
                         :key="otherLoginCodeItem.name"
                         :label="otherLoginCodeItem.label" :value="otherLoginCodeItem.name">
              </el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="登录状态:">
            <el-select v-model="searchForm.otherLoginStatusCodeValue" placeholder="请您选择">
              <el-option v-for="otherLoginStatusCodeItem in otherLoginStatusCodeOptions"
                         :key="otherLoginStatusCodeItem.name"
                         :label="otherLoginStatusCodeItem.label" :value="otherLoginStatusCodeItem.name">
              </el-option>
            </el-select>
          </el-form-item>
          <el-form-item>
      ...
      <el-main class="pt-15">
        ...
        <div class="table">
          <el-table :data="data.records" tooltip-effect="dark" style="width: 100%" border
            ...
            <el-table-column prop="loginValue" label="登录值" sortable="custom"></el-table-column>
            ...
            <el-table-column label="操作" width="280" fixed="right">
              <template slot-scope="scope">
                <el-button size="small" type="primary"
                           @click="toDetail(scope.row.loginId)">
                  详情
                </el-button>
                <el-button size="small" type="danger"
                           @click="rowDel(scope.row.loginId)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
  ...
  export default {
    data() {
      return {
        ...
        otherLoginCodeOptions: [{"label": "全部", "name": ""}],
        otherLoginCodeValue: null,
        otherLoginStatusCodeOptions: [{"label": "全部", "name": ""}],
        otherLoginStatusCodeValue: null,
        form: {
          loginValue:
            null,
          loginName:
   ...
   this.params.page = currentPage
      ...
      toAdd() {
        let opath = '/safety/detailAaSubjectOtherLogin/add/' + 0;
        this.$router.push({path: opath})
      },
      toDetail(id) {
        let opath = '/safety/detailAaSubjectOtherLogin/detail/' + id;
        this.$router.push({path: opath})
      },
