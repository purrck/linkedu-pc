      ...
      <div class="importBox">
        ...
        <div class="text-center mt-20">
          ...
          <div class="padding20-y">
            <importFile @callback="importCallback" @before-upload="beforeUpload"></importFile>
          </div>
        </div>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      importCallback(data) {
        this.$router.push({name: "importList", query: data});
        this.isLoaded = false;
      }
    }
  }
