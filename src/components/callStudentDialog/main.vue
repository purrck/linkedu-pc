                ...
                <el-table :data="list" style="width: 100%" border ref="schooltable">
                  ...
                  <el-table-column label="" width="60">
                    <template slot-scope="scope">
                      <el-radio :label="scope.row.studentId" v-model="radio"><span style="display:none">{{scope.row.studentId}}</span></el-radio>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getRoleForDialog() {
        commonApi.getRoleForDialog("/user/studentAd/page", this.params).then((res) => {
