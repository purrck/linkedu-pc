    ...
    <div>
        <el-col :span="12">
            <el-form-item label="学段">
                <el-select class="select-v2-rao p100" popper-class="select-popper-v2-rao" v-model="formData.segment" v-if="!isDisabled" placeholder="请您选择"  @change="segmentChange">
                    <el-option value="">
                        请您选择
                    </el-option>
                ...
                <el-select class="select-v2-rao p100" popper-class="select-popper-v2-rao" v-model="formData.segment" v-if="isDisabled" disabled placeholder="请您选择" @change="segmentChange">
                    <el-option value="">
                        请您选择
                    </el-option>
                    <el-option v-for="(data,index) in segmentList" :key="index"
        ...
        <el-col :span="12" v-show="gradeList.length">
            <el-form-item label="年级">
                <el-select class="select-v2-rao p100" popper-class="select-popper-v2-rao" v-model="formData.grade" placeholder="请您选择" @change="gradeChange">
                    <el-option value="">
                        请您选择
                    </el-option>
        ...
        <el-col :span="12" v-show="subjectList.length">
            <el-form-item label="学科">
                <el-select class="select-v2-rao p100" popper-class="select-popper-v2-rao" v-model="formData.subject" placeholder="请您选择" @change="subjectChange">
                    <el-option value="">
                        请您选择
                    </el-option>
